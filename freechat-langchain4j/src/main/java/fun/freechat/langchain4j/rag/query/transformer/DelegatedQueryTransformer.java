...
public class DelegatedQueryTransformer implements QueryTransformer {
    ...
    @Builder
    public DelegatedQueryTransformer(
            QueryTransformer queryTransformer, Function<Collection<Query>, Collection<Query>> postProcessor) {
    ...
    public Collection<Query> transform(Query query) {
        Collection<Query> queries =
                queryTransformer != null ? queryTransformer.transform(query) : Collections.singleton(query);
