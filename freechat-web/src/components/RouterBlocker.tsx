...
const RouterBlocker = forwardRef<HTMLDivElement, RouterBlockerProps>((props, ref) => {
  ...
  return (
    ...
    >
      <Typography>{message || t('You have unsaved changes. Are you sure you want to leave?')}</Typography>
    </ConfirmModal>
  );
});
