...
public class SysApiTokenRepo {
    private static final String TOKEN_CACHE_KEY = "'SysApiTokenRepo_token_' + #p0";
    private static final String USER_CACHE_KEY = "'SysApiTokenRepo_user_' + #p0";
    private static final String TOKEN_BY_ID_CACHE_KEY = "'SysApiTokenRepo_token_byId_' + #p0";
