...
public class OrgServiceImpl implements OrgService {
    ...
    public Collection<String> addOwners(String userId, Collection<String> owners) {
        ...
        try {
            ...
            for (String ownerId : new HashSet<>(owners)) {
                ...
                OrgRelationship oldRelationship = orgRelationshipMapper
                        .selectOne(c -> c.where(OrgRelationshipDynamicSqlSupport.userId, isEqualTo(userId))
                ...
                if (oldRelationship != null) {
                    ...
                    rows = orgRelationshipMapper.updateByPrimaryKeySelective(oldRelationship
                            .withGmtModified(now)
                            .withEnabled((byte) 1)
    ...
    public Collection<String> addSubordinates(String userId, Collection<String> subordinates) {
        ...
        try {
            ...
            for (String subordinateId : new HashSet<>(subordinates)) {
                ...
                OrgRelationship oldRelationship = orgRelationshipMapper
                        .selectOne(c -> c.where(OrgRelationshipDynamicSqlSupport.userId, isEqualTo(subordinateId))
    ...
    public boolean removeOwners(String userId, Collection<String> owners) {
        ...
        int rows = orgRelationshipMapper.delete(c -> c.where(OrgRelationshipDynamicSqlSupport.userId, isEqualTo(userId))
    ...
    public boolean removeSubordinates(String userId, Collection<String> subordinates) {
        ...
        int rows =
                orgRelationshipMapper.delete(c -> c.where(OrgRelationshipDynamicSqlSupport.ownerId, isEqualTo(userId))
    ...
    public boolean removeSubordinatesTree(String userId) {
        ...
        TreeSet<String> subordinates = (TreeSet<String>)
                orgRelationshipRepo.getSubordinates(userId, false).tailSet(userId);
        boolean successful = false;
        for (String subordinateId : subordinates.descendingSet()) {
            int rows = orgRelationshipMapper.delete(
                    c -> c.where(OrgRelationshipDynamicSqlSupport.ownerId, isEqualTo(subordinateId)));
    ...
    public boolean updateOwners(String userId, Collection<String> owners) {
        ...
        Set<String> banOwners =
                orgRelationshipMapper
                        .select(c -> c.where(OrgRelationshipDynamicSqlSupport.userId, isEqualTo(userId)))
                        .stream()
    ...
    public boolean updateSubordinates(String userId, Collection<String> subordinates) {
        ...
        Set<String> banSubordinates =
                orgRelationshipMapper
                        .select(c -> c.where(OrgRelationshipDynamicSqlSupport.ownerId, isEqualTo(userId)))
                        .stream()
