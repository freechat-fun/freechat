...
public class OAuth2AuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
        ...
        Authentication sysAuth = StringUtils.isNotBlank(state)
                ? oAuth2AuthorizationRequestCustomizer.getAndDeleteCachedAuthentication(state)
                : null;
        ...
        if (authentication instanceof OAuth2AuthenticationToken oAuth2Auth) {
            ...
            if (sysAuth != null && sysAuth.getPrincipal() instanceof SysUserDetails userDetails) {
                ...
                sysAuth = UsernamePasswordAuthenticationToken.authenticated(
                        sysUser, oAuth2Auth.getCredentials(), sysUser.getAuthorities());
            }
