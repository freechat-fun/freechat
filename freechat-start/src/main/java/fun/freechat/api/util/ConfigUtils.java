...
public class ConfigUtils {
    ...
    // default values
    public static final long DEFAULT_AVATAR_MAX_SIZE = 1024 * 1024;
    public static final int DEFAULT_AVATAR_MAX_COUNT = 10;
    public static final long DEFAULT_DOCUMENT_MAX_SIZE = 10 * 1024 * 1024;
    public static final int DEFAULT_DOCUMENT_MAX_COUNT = 5;
    public static final long DEFAULT_PICTURE_MAX_SIZE = 2 * 1024 * 1024;
