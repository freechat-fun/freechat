...
class InteractiveStatsApiIT extends AbstractIntegrationTest {
    ...
    public void should_pass_all_tests() {
        testClient
                .post()
                .uri("/api/v2/stats/prompt/" + promptUid + "/score/5")
        ...
        testClient
                .post()
                .uri("/api/v2/stats/prompt/" + promptUid + "/refer_count")
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + apiToken)
                .exchange()
                .expectStatus()
        ...
        testClient
                .post()
                .uri("/api/v2/stats/prompt/" + promptUid + "/score/3")
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + apiToken)
                .exchange()
                .expectStatus()
        ...
        testClient
                .get()
                .uri("/api/v2/public/stats/prompt/" + promptUid + "/score")
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + apiToken)
                .exchange()
                .expectStatus()
        ...
        testClient
                .get()
                .uri("/api/v2/public/score/prompt/" + promptUid)
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + apiToken)
                .exchange()
                .expectStatus()
        ...
        testClient
                .get()
                .uri("/api/v2/public/stats/prompt/" + promptUid)
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + apiToken)
                .exchange()
                .expectStatus()
        ...
        testClient
                .get()
                .uri("/api/v2/public/stats/prompts/by/score/10/0")
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + apiToken)
                .exchange()
                .expectStatus()
                ...
                .isEqualTo("Integration-test Prompt for " + userId)
                .jsonPath(jsonPathPrefix + ".referCount")
                .isEqualTo(1)
                .jsonPath(jsonPathPrefix + ".scoreCount")
                .isEqualTo(1)
                .jsonPath(jsonPathPrefix + ".score")
                .isEqualTo(3);
    }
}
