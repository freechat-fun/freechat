...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.CharacterQueryDTO();
  });
  ...
  describe('CharacterQueryDTO', function() {
    it('should create an instance of CharacterQueryDTO', function() {
      // uncomment below and update the code to test CharacterQueryDTO
      //var instance = new freechat-sdk.CharacterQueryDTO();
      //expect(instance).to.be.a(freechat-sdk.CharacterQueryDTO);
    });
