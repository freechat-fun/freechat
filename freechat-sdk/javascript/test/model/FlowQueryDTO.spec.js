...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.FlowQueryDTO();
  });
  ...
  describe('FlowQueryDTO', function() {
    it('should create an instance of FlowQueryDTO', function() {
      // uncomment below and update the code to test FlowQueryDTO
      //var instance = new freechat-sdk.FlowQueryDTO();
      //expect(instance).to.be.a(freechat-sdk.FlowQueryDTO);
    });
