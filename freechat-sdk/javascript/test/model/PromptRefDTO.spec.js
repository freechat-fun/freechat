...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptRefDTO();
  });
  ...
  describe('PromptRefDTO', function() {
    it('should create an instance of PromptRefDTO', function() {
      // uncomment below and update the code to test PromptRefDTO
      //var instance = new freechat-sdk.PromptRefDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptRefDTO);
    });
