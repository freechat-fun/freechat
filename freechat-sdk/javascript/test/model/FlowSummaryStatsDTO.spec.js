...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.FlowSummaryStatsDTO();
  });
  ...
  describe('FlowSummaryStatsDTO', function() {
    it('should create an instance of FlowSummaryStatsDTO', function() {
      // uncomment below and update the code to test FlowSummaryStatsDTO
      //var instance = new freechat-sdk.FlowSummaryStatsDTO();
      //expect(instance).to.be.a(freechat-sdk.FlowSummaryStatsDTO);
    });
