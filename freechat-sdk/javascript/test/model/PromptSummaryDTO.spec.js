...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptSummaryDTO();
  });
  ...
  describe('PromptSummaryDTO', function() {
    it('should create an instance of PromptSummaryDTO', function() {
      // uncomment below and update the code to test PromptSummaryDTO
      //var instance = new freechat-sdk.PromptSummaryDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptSummaryDTO);
    });
