...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptTemplateDTO();
  });
  ...
  describe('PromptTemplateDTO', function() {
    it('should create an instance of PromptTemplateDTO', function() {
      // uncomment below and update the code to test PromptTemplateDTO
      //var instance = new freechat-sdk.PromptTemplateDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptTemplateDTO);
    });
