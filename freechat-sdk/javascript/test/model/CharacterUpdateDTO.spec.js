...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.CharacterUpdateDTO();
  });
  ...
  describe('CharacterUpdateDTO', function() {
    it('should create an instance of CharacterUpdateDTO', function() {
      // uncomment below and update the code to test CharacterUpdateDTO
      //var instance = new freechat-sdk.CharacterUpdateDTO();
      //expect(instance).to.be.a(freechat-sdk.CharacterUpdateDTO);
    });
