...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PluginSummaryDTO();
  });
  ...
  describe('PluginSummaryDTO', function() {
    it('should create an instance of PluginSummaryDTO', function() {
      // uncomment below and update the code to test PluginSummaryDTO
      //var instance = new freechat-sdk.PluginSummaryDTO();
      //expect(instance).to.be.a(freechat-sdk.PluginSummaryDTO);
    });
