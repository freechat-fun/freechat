...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptUpdateDTO();
  });
  ...
  describe('PromptUpdateDTO', function() {
    it('should create an instance of PromptUpdateDTO', function() {
      // uncomment below and update the code to test PromptUpdateDTO
      //var instance = new freechat-sdk.PromptUpdateDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptUpdateDTO);
    });
