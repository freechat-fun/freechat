...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.CharacterSummaryDTO();
  });
  ...
  describe('CharacterSummaryDTO', function() {
    it('should create an instance of CharacterSummaryDTO', function() {
      // uncomment below and update the code to test CharacterSummaryDTO
      //var instance = new freechat-sdk.CharacterSummaryDTO();
      //expect(instance).to.be.a(freechat-sdk.CharacterSummaryDTO);
    });
