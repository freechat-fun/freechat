...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PluginCreateDTO();
  });
  ...
  describe('PluginCreateDTO', function() {
    it('should create an instance of PluginCreateDTO', function() {
      // uncomment below and update the code to test PluginCreateDTO
      //var instance = new freechat-sdk.PluginCreateDTO();
      //expect(instance).to.be.a(freechat-sdk.PluginCreateDTO);
    });
