...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.UserFullDetailsDTO();
  });
  ...
  describe('UserFullDetailsDTO', function() {
    it('should create an instance of UserFullDetailsDTO', function() {
      // uncomment below and update the code to test UserFullDetailsDTO
      //var instance = new freechat-sdk.UserFullDetailsDTO();
      //expect(instance).to.be.a(freechat-sdk.UserFullDetailsDTO);
    });
