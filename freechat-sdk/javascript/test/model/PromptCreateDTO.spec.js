...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptCreateDTO();
  });
  ...
  describe('PromptCreateDTO', function() {
    it('should create an instance of PromptCreateDTO', function() {
      // uncomment below and update the code to test PromptCreateDTO
      //var instance = new freechat-sdk.PromptCreateDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptCreateDTO);
    });
