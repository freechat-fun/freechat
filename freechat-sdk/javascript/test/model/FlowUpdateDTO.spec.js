...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.FlowUpdateDTO();
  });
  ...
  describe('FlowUpdateDTO', function() {
    it('should create an instance of FlowUpdateDTO', function() {
      // uncomment below and update the code to test FlowUpdateDTO
      //var instance = new freechat-sdk.FlowUpdateDTO();
      //expect(instance).to.be.a(freechat-sdk.FlowUpdateDTO);
    });
