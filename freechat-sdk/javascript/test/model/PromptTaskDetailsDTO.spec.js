...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptTaskDetailsDTO();
  });
  ...
  describe('PromptTaskDetailsDTO', function() {
    it('should create an instance of PromptTaskDetailsDTO', function() {
      // uncomment below and update the code to test PromptTaskDetailsDTO
      //var instance = new freechat-sdk.PromptTaskDetailsDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptTaskDetailsDTO);
    });
    ...
    it('should have the property gmtExecuted (base name: "gmtExecuted")', function() {
      // uncomment below and update the code to test the property gmtExecuted
      //var instance = new freechat-sdk.PromptTaskDetailsDTO();
      //expect(instance).to.be();
    });
