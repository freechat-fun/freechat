...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.PromptQueryDTO();
  });
  ...
  describe('PromptQueryDTO', function() {
    it('should create an instance of PromptQueryDTO', function() {
      // uncomment below and update the code to test PromptQueryDTO
      //var instance = new freechat-sdk.PromptQueryDTO();
      //expect(instance).to.be.a(freechat-sdk.PromptQueryDTO);
    });
