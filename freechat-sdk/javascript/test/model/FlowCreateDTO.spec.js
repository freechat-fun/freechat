...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new freechat-sdk.FlowCreateDTO();
  });
  ...
  describe('FlowCreateDTO', function() {
    it('should create an instance of FlowCreateDTO', function() {
      // uncomment below and update the code to test FlowCreateDTO
      //var instance = new freechat-sdk.FlowCreateDTO();
      //expect(instance).to.be.a(freechat-sdk.FlowCreateDTO);
    });
