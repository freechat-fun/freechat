...
/**
 * The CharacterCreateDTO model module.
 * @module model/CharacterCreateDTO
 * @version 0.1.0
 */
class CharacterCreateDTO {
    /**
     * Constructs a new <code>CharacterCreateDTO</code>.
     * Request data for creating new character information
     * @alias module:model/CharacterCreateDTO
     * @param name {String} Character name
     */
    constructor(name) { 
        
        CharacterCreateDTO.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>CharacterCreateDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CharacterCreateDTO} obj Optional instance to populate.
     * @return {module:model/CharacterCreateDTO} The populated <code>CharacterCreateDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CharacterCreateDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>CharacterCreateDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CharacterCreateDTO</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CharacterCreateDTO.RequiredProperties) {
            if (!data[property]) {
...
CharacterCreateDTO.RequiredProperties = ["name"];

/**
 * Referenced character
 * @member {String} parentId
 */
CharacterCreateDTO.prototype['parentId'] = undefined;

/**
 * Visibility: private (default), public, public_org, hidden
 * @member {String} visibility
 */
CharacterCreateDTO.prototype['visibility'] = undefined;

/**
 * Character name
 * @member {String} name
 */
CharacterCreateDTO.prototype['name'] = undefined;

/**
 * Character description
 * @member {String} description
 */
CharacterCreateDTO.prototype['description'] = undefined;

/**
 * Character avatar url
 * @member {String} avatar
 */
CharacterCreateDTO.prototype['avatar'] = undefined;

/**
 * Character picture url
 * @member {String} picture
 */
CharacterCreateDTO.prototype['picture'] = undefined;

/**
 * Character gender: male | female | non_human | unknown
 * @member {String} gender
 */
CharacterCreateDTO.prototype['gender'] = undefined;

/**
 * Character profile
 * @member {String} profile
 */
CharacterCreateDTO.prototype['profile'] = undefined;

/**
 * Character greeting
 * @member {String} greeting
 */
CharacterCreateDTO.prototype['greeting'] = undefined;

/**
 * Character chat-style
 * @member {String} chatStyle
 */
CharacterCreateDTO.prototype['chatStyle'] = undefined;

/**
 * Character chat-example
 * @member {String} chatExample
 */
CharacterCreateDTO.prototype['chatExample'] = undefined;

/**
 * Character experience
 * @member {String} experience
 */
CharacterCreateDTO.prototype['experience'] = undefined;

/**
 * Character language: English | Chinese (Simplified) | ...
 * @member {String} lang
 */
CharacterCreateDTO.prototype['lang'] = undefined;

/**
 * Additional information, JSON format
 * @member {String} ext
 */
CharacterCreateDTO.prototype['ext'] = undefined;

/**
 * @member {module:model/CharacterInfoDraftDTO} draft
 */
CharacterCreateDTO.prototype['draft'] = undefined;

/**
 * Tag set
 * @member {Array.<String>} tags
 */
CharacterCreateDTO.prototype['tags'] = undefined;
...
export default CharacterCreateDTO;
