...
/**
 * API tests for TelegramManagerForAdminApi
 */
@Disabled
public class TelegramManagerForAdminApiTest {

    private final TelegramManagerForAdminApi api = new TelegramManagerForAdminApi();
     ...
     */
    @Test
    public void findTelegramChatTest() throws ApiException {
        String backendId = null;
        Long tgChatId = null;
        String response = api.findTelegramChat(backendId, tgChatId);
     ...
     */
    @Test
    public void listTelegramMessagesTest() throws ApiException {
        String chatId = null;
        Integer limit = null;
        Integer offset = null;
        List<TgMessageDTO> response = api.listTelegramMessages(chatId, limit, offset);
        // TODO: test validations
    }
