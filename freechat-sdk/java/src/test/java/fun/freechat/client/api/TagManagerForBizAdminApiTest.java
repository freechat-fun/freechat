...
/**
 * API tests for TagManagerForBizAdminApi
 */
@Disabled
public class TagManagerForBizAdminApiTest {

    private final TagManagerForBizAdminApi api = new TagManagerForBizAdminApi();
    ...
    public void createTagTest() throws ApiException {
        ...
        String referId = null;
        String tag = null;
        Boolean response = api.createTag(referType, referId, tag);
    ...
    public void deleteTagTest() throws ApiException {
        ...
        String referId = null;
        String tag = null;
        Boolean response = api.deleteTag(referType, referId, tag);
        // TODO: test validations
    }
