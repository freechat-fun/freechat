...
public class AgentQueryDTO {
  ...
  public AgentQueryDTO where(@javax.annotation.Nullable AgentQueryWhere where) {
    this.where = where;
    return this;
  }
  ...
  public void setWhere(@javax.annotation.Nullable AgentQueryWhere where) {
    this.where = where;
  }


  public AgentQueryDTO orderBy(@javax.annotation.Nullable List<String> orderBy) {
  ...
  public AgentQueryDTO pageNum(@javax.annotation.Nullable Long pageNum) {
  ...
  public AgentQueryDTO pageSize(@javax.annotation.Nullable Long pageSize) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentQueryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentQueryDTO is not found in the empty JSON string", AgentQueryDTO.openapiRequiredFields.toString()));
        }
      }
