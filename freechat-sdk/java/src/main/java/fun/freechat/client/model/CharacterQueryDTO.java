...
public class CharacterQueryDTO {
  ...
  public CharacterQueryDTO where(@javax.annotation.Nullable CharacterQueryWhere where) {
    this.where = where;
    return this;
  }
  ...
  public void setWhere(@javax.annotation.Nullable CharacterQueryWhere where) {
    this.where = where;
  }


  public CharacterQueryDTO orderBy(@javax.annotation.Nullable List<String> orderBy) {
  ...
  public CharacterQueryDTO pageNum(@javax.annotation.Nullable Long pageNum) {
  ...
  public CharacterQueryDTO pageSize(@javax.annotation.Nullable Long pageSize) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CharacterQueryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CharacterQueryDTO is not found in the empty JSON string", CharacterQueryDTO.openapiRequiredFields.toString()));
        }
      }
