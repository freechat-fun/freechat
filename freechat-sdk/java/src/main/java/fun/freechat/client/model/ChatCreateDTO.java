...
public class ChatCreateDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("userNickname", "userProfile", "characterNickname", "about", "characterUid", "backendId", "apiKeyName", "apiKeyValue", "ext"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCreateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCreateDTO is not found in the empty JSON string", ChatCreateDTO.openapiRequiredFields.toString()));
        }
      }
