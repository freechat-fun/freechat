...
public class OpenAiParamDTO {
  ...
  public OpenAiParamDTO apiKey(@javax.annotation.Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public OpenAiParamDTO apiKeyName(@javax.annotation.Nullable String apiKeyName) {
  ...
  public OpenAiParamDTO modelId(@javax.annotation.Nonnull String modelId) {
  ...
  public OpenAiParamDTO baseUrl(@javax.annotation.Nullable String baseUrl) {
  ...
  public OpenAiParamDTO temperature(@javax.annotation.Nullable Double temperature) {
  ...
  public OpenAiParamDTO topP(@javax.annotation.Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public OpenAiParamDTO maxTokens(@javax.annotation.Nullable Integer maxTokens) {
  ...
  public OpenAiParamDTO presencePenalty(@javax.annotation.Nullable Double presencePenalty) {
  ...
  public OpenAiParamDTO frequencyPenalty(@javax.annotation.Nullable Double frequencyPenalty) {
  ...
  public OpenAiParamDTO seed(@javax.annotation.Nullable Integer seed) {
    this.seed = seed;
    return this;
  }
  ...
  public OpenAiParamDTO stop(@javax.annotation.Nullable List<String> stop) {
    this.stop = stop;
    return this;
  }
