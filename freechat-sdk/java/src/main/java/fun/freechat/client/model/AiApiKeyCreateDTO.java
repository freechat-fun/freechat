...
public class AiApiKeyCreateDTO {
  ...
  public AiApiKeyCreateDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AiApiKeyCreateDTO provider(@javax.annotation.Nonnull String provider) {
  ...
  public AiApiKeyCreateDTO token(@javax.annotation.Nonnull String token) {
    this.token = token;
    return this;
  }
  ...
  public AiApiKeyCreateDTO enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "provider", "token", "enabled"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "provider", "token"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiApiKeyCreateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiApiKeyCreateDTO is not found in the empty JSON string", AiApiKeyCreateDTO.openapiRequiredFields.toString()));
        }
      }
