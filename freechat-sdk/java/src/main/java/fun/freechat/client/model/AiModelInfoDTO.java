...
public class AiModelInfoDTO {
  ...
  public AiModelInfoDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public AiModelInfoDTO modelId(@javax.annotation.Nullable String modelId) {
  ...
  public AiModelInfoDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AiModelInfoDTO description(@javax.annotation.Nullable String description) {
  ...
  public AiModelInfoDTO provider(@javax.annotation.Nullable String provider) {
  ...
  public AiModelInfoDTO type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "modelId", "name", "description", "provider", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiModelInfoDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiModelInfoDTO is not found in the empty JSON string", AiModelInfoDTO.openapiRequiredFields.toString()));
        }
      }
