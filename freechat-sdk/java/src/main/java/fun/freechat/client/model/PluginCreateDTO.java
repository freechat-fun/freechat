...
public class PluginCreateDTO {
  ...
  public PluginCreateDTO() {
  }

  public PluginCreateDTO visibility(@javax.annotation.Nullable String visibility) {
  ...
  public PluginCreateDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PluginCreateDTO manifestFormat(@javax.annotation.Nullable String manifestFormat) {
  ...
  public PluginCreateDTO manifestInfo(@javax.annotation.Nullable String manifestInfo) {
  ...
  public void setManifestInfo(@javax.annotation.Nullable String manifestInfo) {
    this.manifestInfo = manifestInfo;
  }


  public PluginCreateDTO apiFormat(@javax.annotation.Nullable String apiFormat) {
  ...
  public PluginCreateDTO apiInfo(@javax.annotation.Nullable String apiInfo) {
  ...
  public void setApiInfo(@javax.annotation.Nullable String apiInfo) {
    this.apiInfo = apiInfo;
  }


  public PluginCreateDTO provider(@javax.annotation.Nullable String provider) {
  ...
  public PluginCreateDTO ext(@javax.annotation.Nullable String ext) {
    this.ext = ext;
    return this;
  }
  ...
  public PluginCreateDTO tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PluginCreateDTO addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PluginCreateDTO aiModels(@javax.annotation.Nullable List<String> aiModels) {
    this.aiModels = aiModels;
    return this;
  }

  public PluginCreateDTO addAiModelsItem(String aiModelsItem) {
   ...
   * @return the PluginCreateDTO instance itself
   */
  public PluginCreateDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PluginCreateDTO pluginCreateDTO = (PluginCreateDTO) o;
    return Objects.equals(this.visibility, pluginCreateDTO.visibility) &&
        Objects.equals(this.name, pluginCreateDTO.name) &&
        Objects.equals(this.manifestFormat, pluginCreateDTO.manifestFormat) &&
        Objects.equals(this.manifestInfo, pluginCreateDTO.manifestInfo) &&
        Objects.equals(this.apiFormat, pluginCreateDTO.apiFormat) &&
        Objects.equals(this.apiInfo, pluginCreateDTO.apiInfo) &&
        Objects.equals(this.provider, pluginCreateDTO.provider) &&
        Objects.equals(this.ext, pluginCreateDTO.ext) &&
        Objects.equals(this.tags, pluginCreateDTO.tags) &&
        Objects.equals(this.aiModels, pluginCreateDTO.aiModels)&&
        Objects.equals(this.additionalProperties, pluginCreateDTO.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PluginCreateDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("visibility", "name", "manifestFormat", "manifestInfo", "apiFormat", "apiInfo", "provider", "ext", "tags", "aiModels"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PluginCreateDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PluginCreateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PluginCreateDTO is not found in the empty JSON string", PluginCreateDTO.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PluginCreateDTO.openapiRequiredFields) {
      ...
      if ((jsonObj.get("manifestFormat") != null && !jsonObj.get("manifestFormat").isJsonNull()) && !jsonObj.get("manifestFormat").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `manifestFormat` to be a primitive type in the JSON string but got `%s`", jsonObj.get("manifestFormat").toString()));
      }
      if ((jsonObj.get("manifestInfo") != null && !jsonObj.get("manifestInfo").isJsonNull()) && !jsonObj.get("manifestInfo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `manifestInfo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("manifestInfo").toString()));
      }
      if ((jsonObj.get("apiFormat") != null && !jsonObj.get("apiFormat").isJsonNull()) && !jsonObj.get("apiFormat").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `apiFormat` to be a primitive type in the JSON string but got `%s`", jsonObj.get("apiFormat").toString()));
      }
      if ((jsonObj.get("apiInfo") != null && !jsonObj.get("apiInfo").isJsonNull()) && !jsonObj.get("apiInfo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `apiInfo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("apiInfo").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PluginCreateDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PluginCreateDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PluginCreateDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PluginCreateDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PluginCreateDTO>() {
           @Override
           public void write(JsonWriter out, PluginCreateDTO value) throws IOException {
           ...
           @Override
           public PluginCreateDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PluginCreateDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PluginCreateDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PluginCreateDTO
   * @throws IOException if the JSON string is invalid with respect to PluginCreateDTO
   */
  public static PluginCreateDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PluginCreateDTO.class);
  }

  /**
   * Convert an instance of PluginCreateDTO to an JSON string
   *
   * @return JSON string
   */
