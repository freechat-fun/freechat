...
public class PluginSummaryStatsDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "pluginId", "pluginUid", "gmtCreate", "gmtModified", "visibility", "name", "provider", "manifestFormat", "apiFormat", "username", "tags", "aiModels", "viewCount", "referCount", "recommendCount", "scoreCount", "score"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PluginSummaryStatsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PluginSummaryStatsDTO is not found in the empty JSON string", PluginSummaryStatsDTO.openapiRequiredFields.toString()));
        }
      }
