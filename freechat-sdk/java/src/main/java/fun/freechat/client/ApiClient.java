...
import fun.freechat.client.auth.Authentication;
import fun.freechat.client.auth.HttpBasicAuth;
import fun.freechat.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://127.0.0.1:8080";
    ...
    protected void init() {
        ...
        setUserAgent("freechat-sdk/2.8.0/java");
     ...
     * @return a {@link fun.freechat.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws fun.freechat.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws fun.freechat.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws fun.freechat.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws fun.freechat.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws fun.freechat.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws fun.freechat.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws fun.freechat.client.ApiException If fails to update the parameters
     */
     ...
     * @throws fun.freechat.client.ApiException If fail to serialize the request body object into a string
     */
