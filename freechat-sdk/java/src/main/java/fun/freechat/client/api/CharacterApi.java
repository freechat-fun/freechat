...
public class CharacterApi {
     ...
     */
    public List<String> deleteCharacterByName(String name) throws ApiException {
        ApiResponse<List<String>> localVarResp = deleteCharacterByNameWithHttpInfo(name);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> deleteCharacterByNameWithHttpInfo(String name) throws ApiException {
     ...
     */
    public okhttp3.Call deleteCharacterByNameAsync(String name, final ApiCallback<List<String>> _callback) throws ApiException {
