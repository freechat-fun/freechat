...
public class CharacterApi {
    ...
    /**
     * Build call for deleteCharacterVideo
    ...
    public okhttp3.Call deleteCharacterVideoCall(@javax.annotation.Nonnull String key, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/character/video/{key}"
            .replace("{" + "key" + "}", localVarApiClient.escapeString(key.toString()));
    ...
    private okhttp3.Call deleteCharacterVideoValidateBeforeCall(@javax.annotation.Nonnull String key, final ApiCallback _callback) throws ApiException {
        ...
        return deleteCharacterVideoCall(key, _callback);
    ...
    /**
     * Delete Character Video (asynchronously)
     * Delete a video of the character by key.
     * @param key Video key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for deleteCharacterVoice
     * @param characterBackendId The characterBackendId (required)
    ...
    public okhttp3.Call deleteCharacterVoiceCall(@javax.annotation.Nonnull String characterBackendId, @javax.annotation.Nonnull String key, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/character/voice/{characterBackendId}/{key}"
    ...
    private okhttp3.Call deleteCharacterVoiceValidateBeforeCall(@javax.annotation.Nonnull String characterBackendId, @javax.annotation.Nonnull String key, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling deleteCharacterVoice(Async)");
        }

        return deleteCharacterVoiceCall(characterBackendId, key, _callback);
    ...
    /**
     * Delete Character Voice (asynchronously)
     * Delete a voice of the character by key.
     * @param characterBackendId The characterBackendId (required)
     * @param key Voice key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for listCharacterVideos
     * @param characterUid Character unique identifier (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public okhttp3.Call listCharacterVideosCall(@javax.annotation.Nonnull String characterUid, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/character/videos/{characterUid}"
            .replace("{" + "characterUid" + "}", localVarApiClient.escapeString(characterUid.toString()));
    ...
    private okhttp3.Call listCharacterVideosValidateBeforeCall(@javax.annotation.Nonnull String characterUid, final ApiCallback _callback) throws ApiException {
        ...
        return listCharacterVideosCall(characterUid, _callback);
    ...
    /**
     * List Character Videos (asynchronously)
     * List videos of the character.
     * @param characterUid Character unique identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for listCharacterVoices
     * @param characterBackendId The characterBackendId (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public okhttp3.Call listCharacterVoicesCall(@javax.annotation.Nonnull String characterBackendId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/character/voices/{characterBackendId}"
            .replace("{" + "characterBackendId" + "}", localVarApiClient.escapeString(characterBackendId.toString()));
    ...
    private okhttp3.Call listCharacterVoicesValidateBeforeCall(@javax.annotation.Nonnull String characterBackendId, final ApiCallback _callback) throws ApiException {
        ...
        return listCharacterVoicesCall(characterBackendId, _callback);
    ...
    /**
     * List Character Voices (asynchronously)
     * List voices of the character.
     * @param characterBackendId The characterBackendId (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for searchPublicCharacterSummary
     * @param characterQueryDTO Query conditions (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private okhttp3.Call searchPublicCharacterSummaryValidateBeforeCall(@javax.annotation.Nonnull CharacterQueryDTO characterQueryDTO, final ApiCallback _callback) throws ApiException {
        ...
        return searchPublicCharacterSummaryCall(characterQueryDTO, _callback);
    ...
    /**
     * Search Public Character Summary (asynchronously)
     * Search characters: - Specifiable query fields, and relationship:   - Scope: public(fixed).   - Username: exact match. If not specified, search all users.   - Tags: exact match (support and, or logic).   - Name: left match.   - Language, exact match.   - General: name, description, profile, chat style, experience, fuzzy match, one hit is enough; public scope + all user&#39;s general search does not guarantee timeliness. - A certain sorting rule can be specified, such as view count, reference count, rating, time, descending or ascending. - The search result is the character summary content. - Support pagination. 
     * @param characterQueryDTO Query conditions (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for uploadCharacterVideo
     * @param characterUid Character unique identifier (required)
     * @param _file Character video (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call uploadCharacterVideoCall(@javax.annotation.Nonnull String characterUid, @javax.annotation.Nonnull File _file, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/character/video/{characterUid}"
            .replace("{" + "characterUid" + "}", localVarApiClient.escapeString(characterUid.toString()));
    ...
    private okhttp3.Call uploadCharacterVideoValidateBeforeCall(@javax.annotation.Nonnull String characterUid, @javax.annotation.Nonnull File _file, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter '_file' is set
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling uploadCharacterVideo(Async)");
        }

        return uploadCharacterVideoCall(characterUid, _file, _callback);
    ...
    /**
     * Upload Character Video (asynchronously)
     * Upload a video of the character.
     * @param characterUid Character unique identifier (required)
     * @param _file Character video (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for uploadCharacterVoice
     * @param characterBackendId The characterBackendId (required)
     * @param _file Character voice (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call uploadCharacterVoiceCall(@javax.annotation.Nonnull String characterBackendId, @javax.annotation.Nonnull File _file, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/character/voice/{characterBackendId}"
            .replace("{" + "characterBackendId" + "}", localVarApiClient.escapeString(characterBackendId.toString()));
    ...
    private okhttp3.Call uploadCharacterVoiceValidateBeforeCall(@javax.annotation.Nonnull String characterBackendId, @javax.annotation.Nonnull File _file, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter '_file' is set
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling uploadCharacterVoice(Async)");
        }

        return uploadCharacterVoiceCall(characterBackendId, _file, _callback);
    ...
    /**
     * Upload Character Voice (asynchronously)
     * Upload a voice of the character.
     * @param characterBackendId The characterBackendId (required)
     * @param _file Character voice (required)
     * @param _callback The callback to be executed when the API call finishes
