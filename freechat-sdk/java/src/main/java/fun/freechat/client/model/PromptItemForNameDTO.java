...
public class PromptItemForNameDTO {
  ...
  public PromptItemForNameDTO promptId(@javax.annotation.Nullable Long promptId) {
  ...
  public PromptItemForNameDTO version(@javax.annotation.Nullable Integer version) {
  ...
  public PromptItemForNameDTO stats(@javax.annotation.Nullable InteractiveStatsDTO stats) {
    this.stats = stats;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("promptId", "version", "stats"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptItemForNameDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptItemForNameDTO is not found in the empty JSON string", PromptItemForNameDTO.openapiRequiredFields.toString()));
        }
      }
