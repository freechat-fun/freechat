...
public class PluginQueryWhere {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("visibility", "username", "manifestFormat", "apiFormat", "tags", "tagsOp", "aiModels", "aiModelsOp", "name", "provider", "text"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PluginQueryWhere.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PluginQueryWhere is not found in the empty JSON string", PluginQueryWhere.openapiRequiredFields.toString()));
        }
      }
