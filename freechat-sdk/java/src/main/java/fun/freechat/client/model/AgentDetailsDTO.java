...
public class AgentDetailsDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "agentId", "agentUid", "gmtCreate", "gmtModified", "parentUid", "visibility", "format", "version", "name", "description", "username", "tags", "aiModels", "config", "example", "parameters", "ext", "draft"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentDetailsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentDetailsDTO is not found in the empty JSON string", AgentDetailsDTO.openapiRequiredFields.toString()));
        }
      }
