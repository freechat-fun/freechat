...
public class InteractiveStatsDTO {
  ...
  static {
    ...
    openapiFields.add("referType");
    openapiFields.add("referId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InteractiveStatsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InteractiveStatsDTO is not found in the empty JSON string", InteractiveStatsDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("referType") != null && !jsonObj.get("referType").isJsonNull()) && !jsonObj.get("referType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `referType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("referType").toString()));
      }
      if ((jsonObj.get("referId") != null && !jsonObj.get("referId").isJsonNull()) && !jsonObj.get("referId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `referId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("referId").toString()));
      }
  }
