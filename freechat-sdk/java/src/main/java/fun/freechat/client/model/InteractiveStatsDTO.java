...
public class InteractiveStatsDTO {
  ...
  public InteractiveStatsDTO requestId(String requestId) {
  ...
  public InteractiveStatsDTO gmtCreate(OffsetDateTime gmtCreate) {
  ...
  public InteractiveStatsDTO gmtModified(OffsetDateTime gmtModified) {
  ...
  public InteractiveStatsDTO referType(String referType) {
  ...
  public InteractiveStatsDTO referId(String referId) {
  ...
  public InteractiveStatsDTO viewCount(Long viewCount) {
  ...
  public InteractiveStatsDTO referCount(Long referCount) {
  ...
  public InteractiveStatsDTO recommendCount(Long recommendCount) {
  ...
  public InteractiveStatsDTO scoreCount(Long scoreCount) {
  ...
  public InteractiveStatsDTO score(Long score) {
    this.score = score;
    return this;
  }
