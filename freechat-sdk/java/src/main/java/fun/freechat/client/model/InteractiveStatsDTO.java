...
public class InteractiveStatsDTO {
  ...
  public static final String SERIALIZED_NAME_REFER_TYPE = "referType";
  @SerializedName(SERIALIZED_NAME_REFER_TYPE)
  @javax.annotation.Nullable
  private String referType;

  public static final String SERIALIZED_NAME_REFER_ID = "referId";
  @SerializedName(SERIALIZED_NAME_REFER_ID)
  @javax.annotation.Nullable
  ...
  public InteractiveStatsDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public InteractiveStatsDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public InteractiveStatsDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public InteractiveStatsDTO referType(@javax.annotation.Nullable String referType) {
  ...
  public void setReferType(@javax.annotation.Nullable String referType) {
    this.referType = referType;
  }


  public InteractiveStatsDTO referId(@javax.annotation.Nullable String referId) {
  ...
  public void setReferId(@javax.annotation.Nullable String referId) {
    this.referId = referId;
  }


  public InteractiveStatsDTO viewCount(@javax.annotation.Nullable Long viewCount) {
  ...
  public InteractiveStatsDTO referCount(@javax.annotation.Nullable Long referCount) {
  ...
  public InteractiveStatsDTO recommendCount(@javax.annotation.Nullable Long recommendCount) {
  ...
  public InteractiveStatsDTO scoreCount(@javax.annotation.Nullable Long scoreCount) {
  ...
  public InteractiveStatsDTO score(@javax.annotation.Nullable Long score) {
    this.score = score;
    return this;
  }
   ...
   * @return the InteractiveStatsDTO instance itself
   */
  public InteractiveStatsDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InteractiveStatsDTO interactiveStatsDTO = (InteractiveStatsDTO) o;
    return Objects.equals(this.requestId, interactiveStatsDTO.requestId) &&
        Objects.equals(this.gmtCreate, interactiveStatsDTO.gmtCreate) &&
        Objects.equals(this.gmtModified, interactiveStatsDTO.gmtModified) &&
        Objects.equals(this.referType, interactiveStatsDTO.referType) &&
        Objects.equals(this.referId, interactiveStatsDTO.referId) &&
        Objects.equals(this.viewCount, interactiveStatsDTO.viewCount) &&
        Objects.equals(this.referCount, interactiveStatsDTO.referCount) &&
        Objects.equals(this.recommendCount, interactiveStatsDTO.recommendCount) &&
        Objects.equals(this.scoreCount, interactiveStatsDTO.scoreCount) &&
        Objects.equals(this.score, interactiveStatsDTO.score)&&
        Objects.equals(this.additionalProperties, interactiveStatsDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, gmtCreate, gmtModified, referType, referId, viewCount, referCount, recommendCount, scoreCount, score, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InteractiveStatsDTO {\n");
    sb.append("    requestId: ").append(toIndentedString(requestId)).append("\n");
    sb.append("    gmtCreate: ").append(toIndentedString(gmtCreate)).append("\n");
    sb.append("    gmtModified: ").append(toIndentedString(gmtModified)).append("\n");
    sb.append("    referType: ").append(toIndentedString(referType)).append("\n");
    sb.append("    referId: ").append(toIndentedString(referId)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "gmtCreate", "gmtModified", "referType", "referId", "viewCount", "referCount", "recommendCount", "scoreCount", "score"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to InteractiveStatsDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InteractiveStatsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InteractiveStatsDTO is not found in the empty JSON string", InteractiveStatsDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("referType") != null && !jsonObj.get("referType").isJsonNull()) && !jsonObj.get("referType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `referType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("referType").toString()));
      }
      if ((jsonObj.get("referId") != null && !jsonObj.get("referId").isJsonNull()) && !jsonObj.get("referId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `referId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("referId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InteractiveStatsDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InteractiveStatsDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InteractiveStatsDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InteractiveStatsDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<InteractiveStatsDTO>() {
           @Override
           public void write(JsonWriter out, InteractiveStatsDTO value) throws IOException {
           ...
           @Override
           public InteractiveStatsDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             InteractiveStatsDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of InteractiveStatsDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InteractiveStatsDTO
   * @throws IOException if the JSON string is invalid with respect to InteractiveStatsDTO
   */
  public static InteractiveStatsDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InteractiveStatsDTO.class);
  }

  /**
   * Convert an instance of InteractiveStatsDTO to an JSON string
   *
   * @return JSON string
   */
