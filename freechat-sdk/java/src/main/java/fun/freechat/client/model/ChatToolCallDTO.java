...
public class ChatToolCallDTO {
  ...
  public ChatToolCallDTO() {
  }

  public ChatToolCallDTO id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ChatToolCallDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ChatToolCallDTO arguments(@javax.annotation.Nullable String arguments) {
   ...
   * @return the ChatToolCallDTO instance itself
   */
  public ChatToolCallDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChatToolCallDTO chatToolCallDTO = (ChatToolCallDTO) o;
    return Objects.equals(this.id, chatToolCallDTO.id) &&
        Objects.equals(this.name, chatToolCallDTO.name) &&
        Objects.equals(this.arguments, chatToolCallDTO.arguments)&&
        Objects.equals(this.additionalProperties, chatToolCallDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, arguments, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChatToolCallDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "arguments"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChatToolCallDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatToolCallDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatToolCallDTO is not found in the empty JSON string", ChatToolCallDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChatToolCallDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChatToolCallDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChatToolCallDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChatToolCallDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<ChatToolCallDTO>() {
           @Override
           public void write(JsonWriter out, ChatToolCallDTO value) throws IOException {
           ...
           @Override
           public ChatToolCallDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ChatToolCallDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ChatToolCallDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChatToolCallDTO
   * @throws IOException if the JSON string is invalid with respect to ChatToolCallDTO
   */
  public static ChatToolCallDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChatToolCallDTO.class);
  }

  /**
   * Convert an instance of ChatToolCallDTO to an JSON string
   *
   * @return JSON string
   */
