...
public class AgentUpdateDTO {
  ...
  public AgentUpdateDTO parentUid(@javax.annotation.Nullable String parentUid) {
  ...
  public AgentUpdateDTO visibility(@javax.annotation.Nullable String visibility) {
  ...
  public AgentUpdateDTO format(@javax.annotation.Nullable String format) {
    this.format = format;
    return this;
  }
  ...
  public AgentUpdateDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentUpdateDTO description(@javax.annotation.Nullable String description) {
  ...
  public AgentUpdateDTO config(@javax.annotation.Nullable String config) {
    this.config = config;
    return this;
  }
  ...
  public AgentUpdateDTO example(@javax.annotation.Nullable String example) {
  ...
  public AgentUpdateDTO parameters(@javax.annotation.Nullable String parameters) {
  ...
  public AgentUpdateDTO ext(@javax.annotation.Nullable String ext) {
    this.ext = ext;
    return this;
  }
  ...
  public AgentUpdateDTO draft(@javax.annotation.Nullable String draft) {
    this.draft = draft;
    return this;
  }
  ...
  public AgentUpdateDTO tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AgentUpdateDTO aiModels(@javax.annotation.Nullable List<String> aiModels) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("parentUid", "visibility", "format", "name", "description", "config", "example", "parameters", "ext", "draft", "tags", "aiModels"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentUpdateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentUpdateDTO is not found in the empty JSON string", AgentUpdateDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("parameters") != null && !jsonObj.get("parameters").isJsonNull()) && !jsonObj.get("parameters").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `parameters` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parameters").toString()));
      }
