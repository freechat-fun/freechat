...
public class AppMetaForAdminApi {
     ...
     */
    public okhttp3.Call exposeCall(OpenAiParamDTO openAiParam, QwenParamDTO qwenParam, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/admin/app/expose";
    ...
    private okhttp3.Call exposeValidateBeforeCall(OpenAiParamDTO openAiParam, QwenParamDTO qwenParam, final ApiCallback _callback) throws ApiException {
        ...
        return exposeCall(openAiParam, qwenParam, _callback);
     ...
     */
    public String expose(OpenAiParamDTO openAiParam, QwenParamDTO qwenParam) throws ApiException {
        ApiResponse<String> localVarResp = exposeWithHttpInfo(openAiParam, qwenParam);
     ...
     */
    public ApiResponse<String> exposeWithHttpInfo(OpenAiParamDTO openAiParam, QwenParamDTO qwenParam) throws ApiException {
        okhttp3.Call localVarCall = exposeValidateBeforeCall(openAiParam, qwenParam, null);
     ...
     */
    public okhttp3.Call exposeAsync(OpenAiParamDTO openAiParam, QwenParamDTO qwenParam, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = exposeValidateBeforeCall(openAiParam, qwenParam, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
    ...
    public okhttp3.Call getAppMetaCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/admin/app/meta";
