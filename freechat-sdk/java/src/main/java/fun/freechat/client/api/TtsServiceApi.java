...
public class TtsServiceApi {
    ...
    public TtsServiceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for listTtsBuiltinSpeakers
     ...
     */
    public okhttp3.Call listTtsBuiltinSpeakersCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/public/tts/builtin/speakers";
    ...
    private okhttp3.Call listTtsBuiltinSpeakersValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return listTtsBuiltinSpeakersCall(_callback);
     ...
     */
    public List<String> listTtsBuiltinSpeakers() throws ApiException {
        ApiResponse<List<String>> localVarResp = listTtsBuiltinSpeakersWithHttpInfo();
     ...
     */
    public ApiResponse<List<String>> listTtsBuiltinSpeakersWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listTtsBuiltinSpeakersValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Builtin Speakers (asynchronously)
     * Return builtin TTS speakers.
     ...
     */
    public okhttp3.Call listTtsBuiltinSpeakersAsync(final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTtsBuiltinSpeakersValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for playSample
     * @param speakerType The speaker type (required)
     * @param speaker The speaker (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call playSampleCall(@javax.annotation.Nonnull String speakerType, @javax.annotation.Nonnull String speaker, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/public/tts/play/sample/{speakerType}/{speaker}"
            .replace("{" + "speakerType" + "}", localVarApiClient.escapeString(speakerType.toString()))
            .replace("{" + "speaker" + "}", localVarApiClient.escapeString(speaker.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call playSampleValidateBeforeCall(@javax.annotation.Nonnull String speakerType, @javax.annotation.Nonnull String speaker, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'speakerType' is set
        if (speakerType == null) {
            throw new ApiException("Missing the required parameter 'speakerType' when calling playSample(Async)");
        }

        // verify the required parameter 'speaker' is set
        if (speaker == null) {
            throw new ApiException("Missing the required parameter 'speaker' when calling playSample(Async)");
        }

        return playSampleCall(speakerType, speaker, _callback);
     ...
     */
    public Object playSample(@javax.annotation.Nonnull String speakerType, @javax.annotation.Nonnull String speaker) throws ApiException {
        ApiResponse<Object> localVarResp = playSampleWithHttpInfo(speakerType, speaker);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> playSampleWithHttpInfo(@javax.annotation.Nonnull String speakerType, @javax.annotation.Nonnull String speaker) throws ApiException {
        okhttp3.Call localVarCall = playSampleValidateBeforeCall(speakerType, speaker, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Play Sample Audio (asynchronously)
     * Play TTS sample audio of the builtin/custom speaker.
     * @param speakerType The speaker type (required)
     * @param speaker The speaker (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call playSampleAsync(@javax.annotation.Nonnull String speakerType, @javax.annotation.Nonnull String speaker, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = playSampleValidateBeforeCall(speakerType, speaker, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for speakMessage
     ...
     */
    public okhttp3.Call speakMessageCall(@javax.annotation.Nonnull Long messageId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/tts/speak/{messageId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call speakMessageValidateBeforeCall(@javax.annotation.Nonnull Long messageId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'messageId' is set
        if (messageId == null) {
            throw new ApiException("Missing the required parameter 'messageId' when calling speakMessage(Async)");
        }

        return speakMessageCall(messageId, _callback);
     ...
     */
    public Object speakMessage(@javax.annotation.Nonnull Long messageId) throws ApiException {
        ApiResponse<Object> localVarResp = speakMessageWithHttpInfo(messageId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> speakMessageWithHttpInfo(@javax.annotation.Nonnull Long messageId) throws ApiException {
        okhttp3.Call localVarCall = speakMessageValidateBeforeCall(messageId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call speakMessageAsync(@javax.annotation.Nonnull Long messageId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = speakMessageValidateBeforeCall(messageId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
