...
public class ChatContentDTO {
  ...
  public ChatContentDTO type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }

  /**
   * Chat type: text (default) | image | video | audio | pdf | ...
   * @return type
   */
  @javax.annotation.Nullable
  ...
  public ChatContentDTO content(@javax.annotation.Nonnull String content) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, chatContentDTO.type) &&
        Objects.equals(this.content, chatContentDTO.content)&&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatContentDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatContentDTO is not found in the empty JSON string", ChatContentDTO.openapiRequiredFields.toString()));
        }
      }
