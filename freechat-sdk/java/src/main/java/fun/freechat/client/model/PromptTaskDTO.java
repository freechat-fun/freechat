...
public class PromptTaskDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("promptRef", "modelId", "apiKeyName", "apiKeyValue", "params", "cron", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("promptRef"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptTaskDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptTaskDTO is not found in the empty JSON string", PromptTaskDTO.openapiRequiredFields.toString()));
        }
      }
