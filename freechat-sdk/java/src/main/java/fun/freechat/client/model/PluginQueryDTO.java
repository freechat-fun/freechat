...
public class PluginQueryDTO {
  ...
  public PluginQueryDTO where(@javax.annotation.Nullable PluginQueryWhere where) {
    this.where = where;
    return this;
  }
  ...
  public void setWhere(@javax.annotation.Nullable PluginQueryWhere where) {
    this.where = where;
  }


  public PluginQueryDTO orderBy(@javax.annotation.Nullable List<String> orderBy) {
  ...
  public PluginQueryDTO pageNum(@javax.annotation.Nullable Long pageNum) {
  ...
  public PluginQueryDTO pageSize(@javax.annotation.Nullable Long pageSize) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PluginQueryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PluginQueryDTO is not found in the empty JSON string", PluginQueryDTO.openapiRequiredFields.toString()));
        }
      }
