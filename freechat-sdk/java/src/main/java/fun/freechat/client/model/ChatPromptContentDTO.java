...
public class ChatPromptContentDTO {
  ...
  public ChatPromptContentDTO system(@javax.annotation.Nullable String system) {
    this.system = system;
    return this;
  }
  ...
  public ChatPromptContentDTO messageToSend(@javax.annotation.Nullable ChatMessageDTO messageToSend) {
  ...
  public void setMessageToSend(@javax.annotation.Nullable ChatMessageDTO messageToSend) {
    this.messageToSend = messageToSend;
  }


  public ChatPromptContentDTO messages(@javax.annotation.Nullable List<ChatMessageDTO> messages) {
  ...
  public void setMessages(@javax.annotation.Nullable List<ChatMessageDTO> messages) {
    this.messages = messages;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("system", "messageToSend", "messages"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatPromptContentDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatPromptContentDTO is not found in the empty JSON string", ChatPromptContentDTO.openapiRequiredFields.toString()));
        }
      }
