...
public class AiModelInfoUpdateDTO {
  ...
  public AiModelInfoUpdateDTO() {
  }

  public AiModelInfoUpdateDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AiModelInfoUpdateDTO description(@javax.annotation.Nullable String description) {
  ...
  public AiModelInfoUpdateDTO provider(@javax.annotation.Nullable String provider) {
  ...
  public AiModelInfoUpdateDTO type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the AiModelInfoUpdateDTO instance itself
   */
  public AiModelInfoUpdateDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiModelInfoUpdateDTO aiModelInfoUpdateDTO = (AiModelInfoUpdateDTO) o;
    return Objects.equals(this.name, aiModelInfoUpdateDTO.name) &&
        Objects.equals(this.description, aiModelInfoUpdateDTO.description) &&
        Objects.equals(this.provider, aiModelInfoUpdateDTO.provider) &&
        Objects.equals(this.type, aiModelInfoUpdateDTO.type)&&
        Objects.equals(this.additionalProperties, aiModelInfoUpdateDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, provider, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AiModelInfoUpdateDTO {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiModelInfoUpdateDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiModelInfoUpdateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AiModelInfoUpdateDTO is not found in the empty JSON string", AiModelInfoUpdateDTO.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AiModelInfoUpdateDTO.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiModelInfoUpdateDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiModelInfoUpdateDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiModelInfoUpdateDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiModelInfoUpdateDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<AiModelInfoUpdateDTO>() {
           @Override
           public void write(JsonWriter out, AiModelInfoUpdateDTO value) throws IOException {
           ...
           @Override
           public AiModelInfoUpdateDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiModelInfoUpdateDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiModelInfoUpdateDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiModelInfoUpdateDTO
   * @throws IOException if the JSON string is invalid with respect to AiModelInfoUpdateDTO
   */
  public static AiModelInfoUpdateDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiModelInfoUpdateDTO.class);
  }

  /**
   * Convert an instance of AiModelInfoUpdateDTO to an JSON string
   *
   * @return JSON string
   */
