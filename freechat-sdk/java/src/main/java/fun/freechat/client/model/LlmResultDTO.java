...
public class LlmResultDTO {
  ...
  public LlmResultDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public LlmResultDTO text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public LlmResultDTO message(@javax.annotation.Nullable ChatMessageDTO message) {
  ...
  public void setMessage(@javax.annotation.Nullable ChatMessageDTO message) {
    this.message = message;
  }


  public LlmResultDTO finishReason(@javax.annotation.Nullable String finishReason) {
  ...
  public LlmResultDTO tokenUsage(@javax.annotation.Nullable TokenUsageDTO tokenUsage) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "text", "message", "finishReason", "tokenUsage"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LlmResultDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LlmResultDTO is not found in the empty JSON string", LlmResultDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("finishReason") != null && !jsonObj.get("finishReason").isJsonNull()) && !jsonObj.get("finishReason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `finishReason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("finishReason").toString()));
      }
