...
public class PromptQueryWhere {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("visibility", "username", "tags", "tagsOp", "aiModels", "aiModelsOp", "name", "type", "lang", "text"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptQueryWhere.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptQueryWhere is not found in the empty JSON string", PromptQueryWhere.openapiRequiredFields.toString()));
        }
      }
