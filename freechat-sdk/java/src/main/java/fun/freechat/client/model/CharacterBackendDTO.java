...
public class CharacterBackendDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isDefault, chatPromptTaskId, greetingPromptTaskId, moderationModelId, moderationApiKeyName, moderationParams, messageWindowSize, longTermMemoryWindowSize, initQuota, quotaType, additionalProperties);
  }
