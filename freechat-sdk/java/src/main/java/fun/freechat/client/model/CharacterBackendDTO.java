...
public class CharacterBackendDTO {
  ...
  **/
  ...
  public CharacterBackendDTO longTermMemoryWindowSize(Integer longTermMemoryWindowSize) {
  ...
  **/
  ...
  public CharacterBackendDTO proactiveChatWaitingTime(Integer proactiveChatWaitingTime) {
  ...
  **/
  ...
  public CharacterBackendDTO initQuota(Long initQuota) {
  ...
  **/
  ...
  public CharacterBackendDTO quotaType(String quotaType) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isDefault, chatPromptTaskId, greetingPromptTaskId, moderationModelId, moderationApiKeyName, moderationParams, messageWindowSize, longTermMemoryWindowSize, proactiveChatWaitingTime, initQuota, quotaType, additionalProperties);
  }
