...
public class CharacterBackendDTO {
  ...
  public static final String SERIALIZED_NAME_MODERATION_API_KEY_VALUE = "moderationApiKeyValue";
  @SerializedName(SERIALIZED_NAME_MODERATION_API_KEY_VALUE)
  @javax.annotation.Nullable
  ...
  public static final String SERIALIZED_NAME_IMAGE_MODEL_ID = "imageModelId";
  @SerializedName(SERIALIZED_NAME_IMAGE_MODEL_ID)
  @javax.annotation.Nullable
  private String imageModelId;

  public static final String SERIALIZED_NAME_IMAGE_API_KEY_NAME = "imageApiKeyName";
  @SerializedName(SERIALIZED_NAME_IMAGE_API_KEY_NAME)
  @javax.annotation.Nullable
  private String imageApiKeyName;

  public static final String SERIALIZED_NAME_IMAGE_API_KEY_VALUE = "imageApiKeyValue";
  @SerializedName(SERIALIZED_NAME_IMAGE_API_KEY_VALUE)
  @javax.annotation.Nullable
  private String imageApiKeyValue;

  public static final String SERIALIZED_NAME_IMAGE_PARAMS = "imageParams";
  @SerializedName(SERIALIZED_NAME_IMAGE_PARAMS)
  @javax.annotation.Nullable
  ...
  public static final String SERIALIZED_NAME_TG_BOT_ID = "tgBotId";
  @SerializedName(SERIALIZED_NAME_TG_BOT_ID)
  @javax.annotation.Nullable
  private Long tgBotId;

  public static final String SERIALIZED_NAME_TG_BOT_TOKEN = "tgBotToken";
  @SerializedName(SERIALIZED_NAME_TG_BOT_TOKEN)
  @javax.annotation.Nullable
  ...
  public CharacterBackendDTO isDefault(@javax.annotation.Nullable Boolean isDefault) {
  ...
  public CharacterBackendDTO chatPromptTaskId(@javax.annotation.Nullable String chatPromptTaskId) {
  ...
  public CharacterBackendDTO greetingPromptTaskId(@javax.annotation.Nullable String greetingPromptTaskId) {
  ...
  public CharacterBackendDTO moderationModelId(@javax.annotation.Nullable String moderationModelId) {
  ...
  public CharacterBackendDTO moderationApiKeyName(@javax.annotation.Nullable String moderationApiKeyName) {
  ...
  public CharacterBackendDTO moderationApiKeyValue(@javax.annotation.Nullable String moderationApiKeyValue) {
    this.moderationApiKeyValue = moderationApiKeyValue;
    return this;
  }

  /**
   * Api key value for moderation model
  ...
  public void setModerationApiKeyValue(@javax.annotation.Nullable String moderationApiKeyValue) {
    this.moderationApiKeyValue = moderationApiKeyValue;
  }


  public CharacterBackendDTO moderationParams(@javax.annotation.Nullable String moderationParams) {
  ...
  public CharacterBackendDTO imageModelId(@javax.annotation.Nullable String imageModelId) {
    this.imageModelId = imageModelId;
    return this;
  }

  /**
   * Image model for the character
   * @return imageModelId
   */
  @javax.annotation.Nullable
  ...
  public void setImageModelId(@javax.annotation.Nullable String imageModelId) {
    this.imageModelId = imageModelId;
  }


  public CharacterBackendDTO imageApiKeyName(@javax.annotation.Nullable String imageApiKeyName) {
    this.imageApiKeyName = imageApiKeyName;
    return this;
  }

  /**
   * Api key name for image model
  ...
  public void setImageApiKeyName(@javax.annotation.Nullable String imageApiKeyName) {
    this.imageApiKeyName = imageApiKeyName;
  }


  public CharacterBackendDTO imageApiKeyValue(@javax.annotation.Nullable String imageApiKeyValue) {
    this.imageApiKeyValue = imageApiKeyValue;
    return this;
  }

  /**
   * Api key value for image model
  ...
  public void setImageApiKeyValue(@javax.annotation.Nullable String imageApiKeyValue) {
    this.imageApiKeyValue = imageApiKeyValue;
  }


  public CharacterBackendDTO imageParams(@javax.annotation.Nullable String imageParams) {
    this.imageParams = imageParams;
    return this;
  }

  /**
   * Parameters for image model
   * @return imageParams
   */
  @javax.annotation.Nullable
  ...
  public void setImageParams(@javax.annotation.Nullable String imageParams) {
    this.imageParams = imageParams;
  }


  public CharacterBackendDTO messageWindowSize(@javax.annotation.Nullable Integer messageWindowSize) {
  ...
  public CharacterBackendDTO longTermMemoryWindowSize(@javax.annotation.Nullable Integer longTermMemoryWindowSize) {
  ...
  public CharacterBackendDTO proactiveChatWaitingTime(@javax.annotation.Nullable Integer proactiveChatWaitingTime) {
  ...
  public CharacterBackendDTO initQuota(@javax.annotation.Nullable Long initQuota) {
  ...
  public CharacterBackendDTO quotaType(@javax.annotation.Nullable String quotaType) {
  ...
  public CharacterBackendDTO enableAlbumTool(@javax.annotation.Nullable Boolean enableAlbumTool) {
  ...
  public CharacterBackendDTO enableTts(@javax.annotation.Nullable Boolean enableTts) {
  ...
  public CharacterBackendDTO ttsSpeakerIdx(@javax.annotation.Nullable String ttsSpeakerIdx) {
  ...
  public CharacterBackendDTO ttsSpeakerWav(@javax.annotation.Nullable String ttsSpeakerWav) {
  ...
  public CharacterBackendDTO ttsSpeakerType(@javax.annotation.Nullable String ttsSpeakerType) {
  ...
  public CharacterBackendDTO tgBotId(@javax.annotation.Nullable Long tgBotId) {
  ...
  public void setTgBotId(@javax.annotation.Nullable Long tgBotId) {
    this.tgBotId = tgBotId;
  }


  public CharacterBackendDTO tgBotToken(@javax.annotation.Nullable String tgBotToken) {
  ...
  public void setTgBotToken(@javax.annotation.Nullable String tgBotToken) {
    this.tgBotToken = tgBotToken;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isDefault, characterBackendDTO.isDefault) &&
        ...
        Objects.equals(this.moderationApiKeyValue, characterBackendDTO.moderationApiKeyValue) &&
        Objects.equals(this.moderationParams, characterBackendDTO.moderationParams) &&
        Objects.equals(this.imageModelId, characterBackendDTO.imageModelId) &&
        Objects.equals(this.imageApiKeyName, characterBackendDTO.imageApiKeyName) &&
        Objects.equals(this.imageApiKeyValue, characterBackendDTO.imageApiKeyValue) &&
        Objects.equals(this.imageParams, characterBackendDTO.imageParams) &&
        Objects.equals(this.messageWindowSize, characterBackendDTO.messageWindowSize) &&
        Objects.equals(this.longTermMemoryWindowSize, characterBackendDTO.longTermMemoryWindowSize) &&
        Objects.equals(this.proactiveChatWaitingTime, characterBackendDTO.proactiveChatWaitingTime) &&
        Objects.equals(this.initQuota, characterBackendDTO.initQuota) &&
        Objects.equals(this.quotaType, characterBackendDTO.quotaType) &&
        Objects.equals(this.enableAlbumTool, characterBackendDTO.enableAlbumTool) &&
        Objects.equals(this.enableTts, characterBackendDTO.enableTts) &&
        Objects.equals(this.ttsSpeakerIdx, characterBackendDTO.ttsSpeakerIdx) &&
        Objects.equals(this.ttsSpeakerWav, characterBackendDTO.ttsSpeakerWav) &&
        Objects.equals(this.ttsSpeakerType, characterBackendDTO.ttsSpeakerType) &&
        Objects.equals(this.tgBotId, characterBackendDTO.tgBotId) &&
        Objects.equals(this.tgBotToken, characterBackendDTO.tgBotToken)&&
        Objects.equals(this.additionalProperties, characterBackendDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isDefault, chatPromptTaskId, greetingPromptTaskId, moderationModelId, moderationApiKeyName, moderationApiKeyValue, moderationParams, imageModelId, imageApiKeyName, imageApiKeyValue, imageParams, messageWindowSize, longTermMemoryWindowSize, proactiveChatWaitingTime, initQuota, quotaType, enableAlbumTool, enableTts, ttsSpeakerIdx, ttsSpeakerWav, ttsSpeakerType, tgBotId, tgBotToken, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    moderationApiKeyValue: ").append(toIndentedString(moderationApiKeyValue)).append("\n");
    sb.append("    moderationParams: ").append(toIndentedString(moderationParams)).append("\n");
    sb.append("    imageModelId: ").append(toIndentedString(imageModelId)).append("\n");
    sb.append("    imageApiKeyName: ").append(toIndentedString(imageApiKeyName)).append("\n");
    sb.append("    imageApiKeyValue: ").append(toIndentedString(imageApiKeyValue)).append("\n");
    sb.append("    imageParams: ").append(toIndentedString(imageParams)).append("\n");
    ...
    sb.append("    tgBotId: ").append(toIndentedString(tgBotId)).append("\n");
    sb.append("    tgBotToken: ").append(toIndentedString(tgBotToken)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationApiKeyValue", "moderationParams", "imageModelId", "imageApiKeyName", "imageApiKeyValue", "imageParams", "messageWindowSize", "longTermMemoryWindowSize", "proactiveChatWaitingTime", "initQuota", "quotaType", "enableAlbumTool", "enableTts", "ttsSpeakerIdx", "ttsSpeakerWav", "ttsSpeakerType", "tgBotId", "tgBotToken"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CharacterBackendDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CharacterBackendDTO is not found in the empty JSON string", CharacterBackendDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("chatPromptTaskId") != null && !jsonObj.get("chatPromptTaskId").isJsonNull()) && !jsonObj.get("chatPromptTaskId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `chatPromptTaskId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("chatPromptTaskId").toString()));
      }
      if ((jsonObj.get("greetingPromptTaskId") != null && !jsonObj.get("greetingPromptTaskId").isJsonNull()) && !jsonObj.get("greetingPromptTaskId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `greetingPromptTaskId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("greetingPromptTaskId").toString()));
      }
      if ((jsonObj.get("moderationModelId") != null && !jsonObj.get("moderationModelId").isJsonNull()) && !jsonObj.get("moderationModelId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `moderationModelId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("moderationModelId").toString()));
      }
      if ((jsonObj.get("moderationApiKeyName") != null && !jsonObj.get("moderationApiKeyName").isJsonNull()) && !jsonObj.get("moderationApiKeyName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `moderationApiKeyName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("moderationApiKeyName").toString()));
      }
      if ((jsonObj.get("moderationApiKeyValue") != null && !jsonObj.get("moderationApiKeyValue").isJsonNull()) && !jsonObj.get("moderationApiKeyValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `moderationApiKeyValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("moderationApiKeyValue").toString()));
      }
      if ((jsonObj.get("moderationParams") != null && !jsonObj.get("moderationParams").isJsonNull()) && !jsonObj.get("moderationParams").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `moderationParams` to be a primitive type in the JSON string but got `%s`", jsonObj.get("moderationParams").toString()));
      }
      if ((jsonObj.get("imageModelId") != null && !jsonObj.get("imageModelId").isJsonNull()) && !jsonObj.get("imageModelId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `imageModelId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("imageModelId").toString()));
      }
      if ((jsonObj.get("imageApiKeyName") != null && !jsonObj.get("imageApiKeyName").isJsonNull()) && !jsonObj.get("imageApiKeyName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `imageApiKeyName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("imageApiKeyName").toString()));
      }
      if ((jsonObj.get("imageApiKeyValue") != null && !jsonObj.get("imageApiKeyValue").isJsonNull()) && !jsonObj.get("imageApiKeyValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `imageApiKeyValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("imageApiKeyValue").toString()));
      }
      if ((jsonObj.get("imageParams") != null && !jsonObj.get("imageParams").isJsonNull()) && !jsonObj.get("imageParams").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `imageParams` to be a primitive type in the JSON string but got `%s`", jsonObj.get("imageParams").toString()));
      }
      if ((jsonObj.get("quotaType") != null && !jsonObj.get("quotaType").isJsonNull()) && !jsonObj.get("quotaType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `quotaType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("quotaType").toString()));
      }
      if ((jsonObj.get("ttsSpeakerIdx") != null && !jsonObj.get("ttsSpeakerIdx").isJsonNull()) && !jsonObj.get("ttsSpeakerIdx").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ttsSpeakerIdx` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ttsSpeakerIdx").toString()));
      }
      if ((jsonObj.get("ttsSpeakerWav") != null && !jsonObj.get("ttsSpeakerWav").isJsonNull()) && !jsonObj.get("ttsSpeakerWav").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ttsSpeakerWav` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ttsSpeakerWav").toString()));
      }
      if ((jsonObj.get("ttsSpeakerType") != null && !jsonObj.get("ttsSpeakerType").isJsonNull()) && !jsonObj.get("ttsSpeakerType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ttsSpeakerType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ttsSpeakerType").toString()));
      }
      if ((jsonObj.get("tgBotToken") != null && !jsonObj.get("tgBotToken").isJsonNull()) && !jsonObj.get("tgBotToken").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tgBotToken` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tgBotToken").toString()));
      }
  }
