...
public class TagManagerForBizAdminApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TagManagerForBizAdminApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TagManagerForBizAdminApi(ApiClient apiClient) {
     ...
     * @param referType Tag type (prompt, agent, plugin...) (required)
     * @param referId Resource identifier of the tag (required)
     * @param tag Tag content (required)
     ...
     */
    public okhttp3.Call createTagCall(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/biz/admin/tag/{referType}/{referId}/{tag}"
            .replace("{" + "referType" + "}", localVarApiClient.escapeString(referType.toString()))
            .replace("{" + "referId" + "}", localVarApiClient.escapeString(referId.toString()))
    ...
    private okhttp3.Call createTagValidateBeforeCall(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'referType' is set
        if (referType == null) {
            throw new ApiException("Missing the required parameter 'referType' when calling createTag(Async)");
        }

        // verify the required parameter 'referId' is set
        if (referId == null) {
            throw new ApiException("Missing the required parameter 'referId' when calling createTag(Async)");
        }
        ...
        return createTagCall(referType, referId, tag, _callback);
     ...
     */
    public Boolean createTag(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag) throws ApiException {
        ApiResponse<Boolean> localVarResp = createTagWithHttpInfo(referType, referId, tag);
     ...
     */
    public ApiResponse<Boolean> createTagWithHttpInfo(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag) throws ApiException {
        okhttp3.Call localVarCall = createTagValidateBeforeCall(referType, referId, tag, null);
     ...
     */
    public okhttp3.Call createTagAsync(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTagValidateBeforeCall(referType, referId, tag, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
     ...
     */
    public okhttp3.Call deleteTagCall(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTagValidateBeforeCall(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'referType' is set
        if (referType == null) {
            throw new ApiException("Missing the required parameter 'referType' when calling deleteTag(Async)");
        }

        // verify the required parameter 'referId' is set
        if (referId == null) {
            throw new ApiException("Missing the required parameter 'referId' when calling deleteTag(Async)");
        }
        ...
        return deleteTagCall(referType, referId, tag, _callback);
     ...
     */
    public Boolean deleteTag(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag) throws ApiException {
        ApiResponse<Boolean> localVarResp = deleteTagWithHttpInfo(referType, referId, tag);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Boolean> deleteTagWithHttpInfo(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag) throws ApiException {
        okhttp3.Call localVarCall = deleteTagValidateBeforeCall(referType, referId, tag, null);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call deleteTagAsync(@javax.annotation.Nonnull String referType, @javax.annotation.Nonnull String referId, @javax.annotation.Nonnull String tag, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteTagValidateBeforeCall(referType, referId, tag, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
