...
public class ApiTokenInfoDTO {
  ...
  public ApiTokenInfoDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ApiTokenInfoDTO id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public ApiTokenInfoDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public ApiTokenInfoDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public ApiTokenInfoDTO type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ApiTokenInfoDTO issuedAt(@javax.annotation.Nullable OffsetDateTime issuedAt) {
  ...
  public ApiTokenInfoDTO expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public ApiTokenInfoDTO token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public ApiTokenInfoDTO policy(@javax.annotation.Nullable String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public ApiTokenInfoDTO username(@javax.annotation.Nullable String username) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "id", "gmtCreate", "gmtModified", "type", "issuedAt", "expiresAt", "token", "policy", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiTokenInfoDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApiTokenInfoDTO is not found in the empty JSON string", ApiTokenInfoDTO.openapiRequiredFields.toString()));
        }
      }
