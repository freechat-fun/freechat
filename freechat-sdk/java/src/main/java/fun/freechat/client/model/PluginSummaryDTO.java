...
public class PluginSummaryDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "pluginId", "pluginUid", "gmtCreate", "gmtModified", "visibility", "name", "provider", "manifestFormat", "apiFormat", "username", "tags", "aiModels"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PluginSummaryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PluginSummaryDTO is not found in the empty JSON string", PluginSummaryDTO.openapiRequiredFields.toString()));
        }
      }
