...
public class UserBasicInfoDTO {
  ...
  public UserBasicInfoDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public UserBasicInfoDTO username(@javax.annotation.Nullable String username) {
  ...
  public UserBasicInfoDTO nickname(@javax.annotation.Nullable String nickname) {
  ...
  public UserBasicInfoDTO picture(@javax.annotation.Nullable String picture) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "username", "nickname", "picture"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserBasicInfoDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserBasicInfoDTO is not found in the empty JSON string", UserBasicInfoDTO.openapiRequiredFields.toString()));
        }
      }
