...
public class CharacterQueryWhere {
  ...
  **/
  ...
  public CharacterQueryWhere priority(Integer priority) {
    this.priority = priority;
    return this;
  }

   /**
   * Character priority, usually 1
   * @return priority
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visibility, characterQueryWhere.visibility) &&
        ...
        Objects.equals(this.priority, characterQueryWhere.priority)&&
        Objects.equals(this.additionalProperties, characterQueryWhere.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(visibility, username, tags, tagsOp, name, lang, text, priority, additionalProperties);
  }
