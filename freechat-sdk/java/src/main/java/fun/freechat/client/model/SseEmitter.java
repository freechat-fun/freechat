...
public class SseEmitter {
  ...
  public SseEmitter timeout(@javax.annotation.Nullable Long timeout) {
   ...
   * @return the SseEmitter instance itself
   */
  public SseEmitter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timeout, sseEmitter.timeout)&&
        Objects.equals(this.additionalProperties, sseEmitter.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SseEmitter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SseEmitter is not found in the empty JSON string", SseEmitter.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SseEmitter>() {
           ...
           public SseEmitter read(JsonReader in) throws IOException {
             ...
             SseEmitter instance = thisAdapter.fromJsonTree(jsonObj);
