...
public class CharacterSummaryDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, characterId, characterUid, gmtCreate, gmtModified, parentUid, visibility, version, name, description, nickname, avatar, picture, gender, lang, greeting, username, tags, additionalProperties);
  }
