...
public class CharacterSummaryStatsDTO {
  ...
  public CharacterSummaryStatsDTO defaultScene(String defaultScene) {
  ...
  public CharacterSummaryStatsDTO priority(Integer priority) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, characterId, characterUid, gmtCreate, gmtModified, parentUid, visibility, version, name, description, nickname, avatar, picture, gender, lang, greeting, defaultScene, priority, username, tags, viewCount, referCount, recommendCount, scoreCount, score, additionalProperties);
  }
