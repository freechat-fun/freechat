...
public class CharacterSummaryStatsDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, characterId, characterUid, gmtCreate, gmtModified, parentUid, visibility, version, name, description, nickname, avatar, picture, gender, lang, username, tags, viewCount, referCount, recommendCount, scoreCount, score, additionalProperties);
  }
