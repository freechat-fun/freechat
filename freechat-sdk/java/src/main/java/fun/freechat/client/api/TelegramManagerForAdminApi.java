...
import fun.freechat.client.model.TgMessageDTO;
...
public class TelegramManagerForAdminApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public TelegramManagerForAdminApi() {
        this(Configuration.getDefaultApiClient());
    }

    public TelegramManagerForAdminApi(ApiClient apiClient) {
    ...
    /**
     * Build call for findTelegramChat
     * @param backendId Character backend identifier (required)
     * @param tgChatId Telegram chat id (required)
     ...
     */
    public okhttp3.Call findTelegramChatCall(@javax.annotation.Nonnull String backendId, @javax.annotation.Nonnull Long tgChatId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/admin/chat/tg/{backendId}/{tgChatId}"
            .replace("{" + "backendId" + "}", localVarApiClient.escapeString(backendId.toString()))
            .replace("{" + "tgChatId" + "}", localVarApiClient.escapeString(tgChatId.toString()));
    ...
    private okhttp3.Call findTelegramChatValidateBeforeCall(@javax.annotation.Nonnull String backendId, @javax.annotation.Nonnull Long tgChatId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'backendId' is set
        if (backendId == null) {
            throw new ApiException("Missing the required parameter 'backendId' when calling findTelegramChat(Async)");
        }

        // verify the required parameter 'tgChatId' is set
        if (tgChatId == null) {
            throw new ApiException("Missing the required parameter 'tgChatId' when calling findTelegramChat(Async)");
        }

        return findTelegramChatCall(backendId, tgChatId, _callback);
     ...
     */
    public String findTelegramChat(@javax.annotation.Nonnull String backendId, @javax.annotation.Nonnull Long tgChatId) throws ApiException {
        ApiResponse<String> localVarResp = findTelegramChatWithHttpInfo(backendId, tgChatId);
     ...
     */
    public ApiResponse<String> findTelegramChatWithHttpInfo(@javax.annotation.Nonnull String backendId, @javax.annotation.Nonnull Long tgChatId) throws ApiException {
        okhttp3.Call localVarCall = findTelegramChatValidateBeforeCall(backendId, tgChatId, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Find Telegram Chat (asynchronously)
     * Look up the FreeChat chat_id bound to a Telegram (backend, tg_chat_id) pair.
     * @param backendId Character backend identifier (required)
     * @param tgChatId Telegram chat id (required)
     ...
     */
    public okhttp3.Call findTelegramChatAsync(@javax.annotation.Nonnull String backendId, @javax.annotation.Nonnull Long tgChatId, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = findTelegramChatValidateBeforeCall(backendId, tgChatId, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listTelegramMessages
     * @param chatId tg_chat.chat_id (required)
     * @param limit Max rows to return (default 100) (optional)
     * @param offset Row offset (default 0) (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listTelegramMessagesCall(@javax.annotation.Nonnull String chatId, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/admin/chat/tg/messages/{chatId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listTelegramMessagesValidateBeforeCall(@javax.annotation.Nonnull String chatId, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'chatId' is set
        if (chatId == null) {
            throw new ApiException("Missing the required parameter 'chatId' when calling listTelegramMessages(Async)");
        }

        return listTelegramMessagesCall(chatId, limit, offset, _callback);
     ...
     */
    public List<TgMessageDTO> listTelegramMessages(@javax.annotation.Nonnull String chatId, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset) throws ApiException {
        ApiResponse<List<TgMessageDTO>> localVarResp = listTelegramMessagesWithHttpInfo(chatId, limit, offset);
        return localVarResp.getData();
    }
     ...
     * @param limit Max rows to return (default 100) (optional)
     * @param offset Row offset (default 0) (optional)
     * @return ApiResponse&lt;List&lt;TgMessageDTO&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<TgMessageDTO>> listTelegramMessagesWithHttpInfo(@javax.annotation.Nonnull String chatId, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset) throws ApiException {
        okhttp3.Call localVarCall = listTelegramMessagesValidateBeforeCall(chatId, limit, offset, null);
        Type localVarReturnType = new TypeToken<List<TgMessageDTO>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Telegram Messages (asynchronously)
     * List Telegram messages recorded against the given tg_chat.chat_id, newest first.
     * @param chatId tg_chat.chat_id (required)
     * @param limit Max rows to return (default 100) (optional)
     * @param offset Row offset (default 0) (optional)
     ...
     */
    public okhttp3.Call listTelegramMessagesAsync(@javax.annotation.Nonnull String chatId, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback<List<TgMessageDTO>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTelegramMessagesValidateBeforeCall(chatId, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<List<TgMessageDTO>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
