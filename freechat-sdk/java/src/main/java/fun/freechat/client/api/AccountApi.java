...
public class AccountApi {
     ...
     */
    public okhttp3.Call getUserBasicCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/account/basic";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserBasicValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getUserBasicCall(_callback);
     ...
     */
    public UserBasicInfoDTO getUserBasic() throws ApiException {
        ApiResponse<UserBasicInfoDTO> localVarResp = getUserBasicWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserBasicInfoDTO> getUserBasicWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getUserBasicValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getUserBasicAsync(final ApiCallback<UserBasicInfoDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserBasicValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<UserBasicInfoDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getUserBasic1Call(String username, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserBasic1ValidateBeforeCall(String username, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling getUserBasic1(Async)");
        }

        return getUserBasic1Call(username, _callback);
     ...
     */
    public UserBasicInfoDTO getUserBasic1(String username) throws ApiException {
        ApiResponse<UserBasicInfoDTO> localVarResp = getUserBasic1WithHttpInfo(username);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserBasicInfoDTO> getUserBasic1WithHttpInfo(String username) throws ApiException {
        okhttp3.Call localVarCall = getUserBasic1ValidateBeforeCall(username, null);
        Type localVarReturnType = new TypeToken<UserBasicInfoDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getUserBasic1Async(String username, final ApiCallback<UserBasicInfoDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserBasic1ValidateBeforeCall(username, _callback);
        Type localVarReturnType = new TypeToken<UserBasicInfoDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
