...
public class AppMetaDTO {
  ...
  public AppMetaDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AppMetaDTO version(@javax.annotation.Nullable String version) {
  ...
  public AppMetaDTO buildTimestamp(@javax.annotation.Nullable String buildTimestamp) {
  ...
  public AppMetaDTO buildNumber(@javax.annotation.Nullable String buildNumber) {
  ...
  public AppMetaDTO commitUrl(@javax.annotation.Nullable String commitUrl) {
  ...
  public AppMetaDTO releaseNoteUrl(@javax.annotation.Nullable String releaseNoteUrl) {
  ...
  public void setReleaseNoteUrl(@javax.annotation.Nullable String releaseNoteUrl) {
    this.releaseNoteUrl = releaseNoteUrl;
  }


  public AppMetaDTO runningEnv(@javax.annotation.Nullable String runningEnv) {
  ...
  public void setRunningEnv(@javax.annotation.Nullable String runningEnv) {
    this.runningEnv = runningEnv;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "version", "buildTimestamp", "buildNumber", "commitUrl", "releaseNoteUrl", "runningEnv"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppMetaDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AppMetaDTO is not found in the empty JSON string", AppMetaDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("buildTimestamp") != null && !jsonObj.get("buildTimestamp").isJsonNull()) && !jsonObj.get("buildTimestamp").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `buildTimestamp` to be a primitive type in the JSON string but got `%s`", jsonObj.get("buildTimestamp").toString()));
      }
      if ((jsonObj.get("buildNumber") != null && !jsonObj.get("buildNumber").isJsonNull()) && !jsonObj.get("buildNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `buildNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("buildNumber").toString()));
      }
      ...
      if ((jsonObj.get("releaseNoteUrl") != null && !jsonObj.get("releaseNoteUrl").isJsonNull()) && !jsonObj.get("releaseNoteUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `releaseNoteUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("releaseNoteUrl").toString()));
      }
      if ((jsonObj.get("runningEnv") != null && !jsonObj.get("runningEnv").isJsonNull()) && !jsonObj.get("runningEnv").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `runningEnv` to be a primitive type in the JSON string but got `%s`", jsonObj.get("runningEnv").toString()));
      }
  }
