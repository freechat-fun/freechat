...
public class EncryptionManagerForAdminApi {
     ...
     */
    public okhttp3.Call encryptTextCall(@javax.annotation.Nonnull String text, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/admin/encryption/encrypt/{text}"
    ...
    private okhttp3.Call encryptTextValidateBeforeCall(@javax.annotation.Nonnull String text, final ApiCallback _callback) throws ApiException {
     ...
     */
    public String encryptText(@javax.annotation.Nonnull String text) throws ApiException {
     ...
     */
    public ApiResponse<String> encryptTextWithHttpInfo(@javax.annotation.Nonnull String text) throws ApiException {
     ...
     */
    public okhttp3.Call encryptTextAsync(@javax.annotation.Nonnull String text, final ApiCallback<String> _callback) throws ApiException {
