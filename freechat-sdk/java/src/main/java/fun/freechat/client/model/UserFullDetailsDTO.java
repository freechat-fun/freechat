...
public class UserFullDetailsDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "username", "nickname", "givenName", "middleName", "familyName", "preferredUsername", "profile", "picture", "website", "email", "gender", "birthdate", "zoneinfo", "locale", "phoneNumber", "updatedAt", "platform", "enabled", "locked", "expiresAt", "passwordExpiresAt", "address", "password"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserFullDetailsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserFullDetailsDTO is not found in the empty JSON string", UserFullDetailsDTO.openapiRequiredFields.toString()));
        }
      }
