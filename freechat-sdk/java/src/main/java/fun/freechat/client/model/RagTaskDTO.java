...
public class RagTaskDTO {
  ...
  public RagTaskDTO sourceType(@javax.annotation.Nullable String sourceType) {
  ...
  public RagTaskDTO source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public RagTaskDTO maxSegmentSize(@javax.annotation.Nullable Integer maxSegmentSize) {
  ...
  public RagTaskDTO maxOverlapSize(@javax.annotation.Nullable Integer maxOverlapSize) {
   ...
   * @return the RagTaskDTO instance itself
   */
  public RagTaskDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RagTaskDTO ragTaskDTO = (RagTaskDTO) o;
    return Objects.equals(this.sourceType, ragTaskDTO.sourceType) &&
        Objects.equals(this.source, ragTaskDTO.source) &&
        Objects.equals(this.maxSegmentSize, ragTaskDTO.maxSegmentSize) &&
        Objects.equals(this.maxOverlapSize, ragTaskDTO.maxOverlapSize)&&
        Objects.equals(this.additionalProperties, ragTaskDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceType, source, maxSegmentSize, maxOverlapSize, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RagTaskDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceType", "source", "maxSegmentSize", "maxOverlapSize"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RagTaskDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RagTaskDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RagTaskDTO is not found in the empty JSON string", RagTaskDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RagTaskDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RagTaskDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RagTaskDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RagTaskDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<RagTaskDTO>() {
           @Override
           public void write(JsonWriter out, RagTaskDTO value) throws IOException {
           ...
           @Override
           public RagTaskDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RagTaskDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RagTaskDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RagTaskDTO
   * @throws IOException if the JSON string is invalid with respect to RagTaskDTO
   */
  public static RagTaskDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RagTaskDTO.class);
  }

  /**
   * Convert an instance of RagTaskDTO to an JSON string
   *
   * @return JSON string
   */
