...
public class PromptAiParamDTO {
  ...
  public static final String SERIALIZED_NAME_PROMPT_TEMPLATE = "promptTemplate";
  @SerializedName(SERIALIZED_NAME_PROMPT_TEMPLATE)
  @javax.annotation.Nullable
  ...
  public PromptAiParamDTO() {
  }

  public PromptAiParamDTO prompt(@javax.annotation.Nullable String prompt) {
    this.prompt = prompt;
    return this;
  }
  ...
  public PromptAiParamDTO promptTemplate(@javax.annotation.Nullable PromptTemplateDTO promptTemplate) {
  ...
  public void setPromptTemplate(@javax.annotation.Nullable PromptTemplateDTO promptTemplate) {
    this.promptTemplate = promptTemplate;
  }


  public PromptAiParamDTO promptRef(@javax.annotation.Nullable PromptRefDTO promptRef) {
  ...
  public PromptAiParamDTO params(@javax.annotation.Nonnull Map<String, Object> params) {
    this.params = params;
    return this;
  }

  public PromptAiParamDTO putParamsItem(String key, Object paramsItem) {
    if (this.params == null) {
   ...
   * @return the PromptAiParamDTO instance itself
   */
  public PromptAiParamDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromptAiParamDTO promptAiParamDTO = (PromptAiParamDTO) o;
    return Objects.equals(this.prompt, promptAiParamDTO.prompt) &&
        Objects.equals(this.promptTemplate, promptAiParamDTO.promptTemplate) &&
        Objects.equals(this.promptRef, promptAiParamDTO.promptRef) &&
        Objects.equals(this.params, promptAiParamDTO.params)&&
        Objects.equals(this.additionalProperties, promptAiParamDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prompt, promptTemplate, promptRef, params, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PromptAiParamDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("prompt", "promptTemplate", "promptRef", "params"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromptAiParamDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptAiParamDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptAiParamDTO is not found in the empty JSON string", PromptAiParamDTO.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromptAiParamDTO.openapiRequiredFields) {
      ...
      if (jsonObj.get("promptTemplate") != null && !jsonObj.get("promptTemplate").isJsonNull()) {
        PromptTemplateDTO.validateJsonElement(jsonObj.get("promptTemplate"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromptAiParamDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromptAiParamDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromptAiParamDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromptAiParamDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PromptAiParamDTO>() {
           @Override
           public void write(JsonWriter out, PromptAiParamDTO value) throws IOException {
           ...
           @Override
           public PromptAiParamDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromptAiParamDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromptAiParamDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromptAiParamDTO
   * @throws IOException if the JSON string is invalid with respect to PromptAiParamDTO
   */
  public static PromptAiParamDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromptAiParamDTO.class);
  }

  /**
   * Convert an instance of PromptAiParamDTO to an JSON string
   *
   * @return JSON string
   */
