...
public class PromptAiParamDTO {
  ...
  static {
    ...
    openapiFields.add("promptTemplate");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptAiParamDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromptAiParamDTO is not found in the empty JSON string", PromptAiParamDTO.openapiRequiredFields.toString()));
        }
      }
