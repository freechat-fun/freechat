...
public class AgentItemForNameDTO {
  ...
  public AgentItemForNameDTO agentId(Long agentId) {
  ...
  public AgentItemForNameDTO version(Integer version) {
  ...
  public AgentItemForNameDTO stats(InteractiveStatsDTO stats) {
    this.stats = stats;
    return this;
  }
