...
public class AgentItemForNameDTO {
  ...
  public AgentItemForNameDTO() {
  }

  public AgentItemForNameDTO agentId(@javax.annotation.Nullable Long agentId) {
  ...
  public AgentItemForNameDTO version(@javax.annotation.Nullable Integer version) {
  ...
  public AgentItemForNameDTO stats(@javax.annotation.Nullable InteractiveStatsDTO stats) {
    this.stats = stats;
    return this;
  }
   ...
   * @return the AgentItemForNameDTO instance itself
   */
  public AgentItemForNameDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentItemForNameDTO agentItemForNameDTO = (AgentItemForNameDTO) o;
    return Objects.equals(this.agentId, agentItemForNameDTO.agentId) &&
        Objects.equals(this.version, agentItemForNameDTO.version) &&
        Objects.equals(this.stats, agentItemForNameDTO.stats)&&
        Objects.equals(this.additionalProperties, agentItemForNameDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agentId, version, stats, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgentItemForNameDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("agentId", "version", "stats"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentItemForNameDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentItemForNameDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentItemForNameDTO is not found in the empty JSON string", AgentItemForNameDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentItemForNameDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentItemForNameDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentItemForNameDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentItemForNameDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentItemForNameDTO>() {
           @Override
           public void write(JsonWriter out, AgentItemForNameDTO value) throws IOException {
           ...
           @Override
           public AgentItemForNameDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentItemForNameDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentItemForNameDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentItemForNameDTO
   * @throws IOException if the JSON string is invalid with respect to AgentItemForNameDTO
   */
  public static AgentItemForNameDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentItemForNameDTO.class);
  }

  /**
   * Convert an instance of AgentItemForNameDTO to an JSON string
   *
   * @return JSON string
   */
