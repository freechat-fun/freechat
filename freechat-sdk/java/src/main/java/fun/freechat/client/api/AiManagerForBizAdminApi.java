...
import fun.freechat.client.model.AiModelInfoUpdateDTO;
...
public class AiManagerForBizAdminApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AiManagerForBizAdminApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AiManagerForBizAdminApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createOrUpdateAiModelInfo
     * @param aiModelInfoUpdateDTO Model information (required)
     ...
     */
    public okhttp3.Call createOrUpdateAiModelInfoCall(AiModelInfoUpdateDTO aiModelInfoUpdateDTO, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = aiModelInfoUpdateDTO;

        // create path and map variables
        String localVarPath = "/api/v2/biz/admin/ai/model";
    ...
    private okhttp3.Call createOrUpdateAiModelInfoValidateBeforeCall(AiModelInfoUpdateDTO aiModelInfoUpdateDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'aiModelInfoUpdateDTO' is set
        if (aiModelInfoUpdateDTO == null) {
            throw new ApiException("Missing the required parameter 'aiModelInfoUpdateDTO' when calling createOrUpdateAiModelInfo(Async)");
        }

        return createOrUpdateAiModelInfoCall(aiModelInfoUpdateDTO, _callback);
     ...
     */
    public String createOrUpdateAiModelInfo(AiModelInfoUpdateDTO aiModelInfoUpdateDTO) throws ApiException {
        ApiResponse<String> localVarResp = createOrUpdateAiModelInfoWithHttpInfo(aiModelInfoUpdateDTO);
     ...
     */
    public ApiResponse<String> createOrUpdateAiModelInfoWithHttpInfo(AiModelInfoUpdateDTO aiModelInfoUpdateDTO) throws ApiException {
        okhttp3.Call localVarCall = createOrUpdateAiModelInfoValidateBeforeCall(aiModelInfoUpdateDTO, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create or Update Model Information (asynchronously)
     * Create or update model information. If no modelId is passed or the modelId does not exist in the database, create a new one (keep the same modelId); otherwise update. Return modelId if successful.
     * @param aiModelInfoUpdateDTO Model information (required)
     ...
     */
    public okhttp3.Call createOrUpdateAiModelInfoAsync(AiModelInfoUpdateDTO aiModelInfoUpdateDTO, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = createOrUpdateAiModelInfoValidateBeforeCall(aiModelInfoUpdateDTO, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteAiModelInfo
     ...
     */
    public okhttp3.Call deleteAiModelInfoCall(String modelId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/biz/admin/ai/model/{modelId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAiModelInfoValidateBeforeCall(String modelId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'modelId' is set
        if (modelId == null) {
            throw new ApiException("Missing the required parameter 'modelId' when calling deleteAiModelInfo(Async)");
        }

        return deleteAiModelInfoCall(modelId, _callback);
     ...
     */
    public Boolean deleteAiModelInfo(String modelId) throws ApiException {
        ApiResponse<Boolean> localVarResp = deleteAiModelInfoWithHttpInfo(modelId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Boolean> deleteAiModelInfoWithHttpInfo(String modelId) throws ApiException {
        okhttp3.Call localVarCall = deleteAiModelInfoValidateBeforeCall(modelId, null);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete Model Information (asynchronously)
     * Delete model information based on modelId.
     * @param modelId Model identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteAiModelInfoAsync(String modelId, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAiModelInfoValidateBeforeCall(modelId, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
