...
public class TgMessageDTO {
  ...
  public static final String SERIALIZED_NAME_TG_MESSAGE_ID = "tgMessageId";
  @SerializedName(SERIALIZED_NAME_TG_MESSAGE_ID)
  @javax.annotation.Nullable
  private Long tgMessageId;

  public static final String SERIALIZED_NAME_TG_USER_ID = "tgUserId";
  @SerializedName(SERIALIZED_NAME_TG_USER_ID)
  @javax.annotation.Nullable
  ...
  public TgMessageDTO id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public TgMessageDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public TgMessageDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public TgMessageDTO chatId(@javax.annotation.Nullable String chatId) {
    this.chatId = chatId;
    return this;
  }

  /**
   * Related tg_chat.chat_id
   * @return chatId
   */
  @javax.annotation.Nullable
  ...
  public TgMessageDTO tgMessageId(@javax.annotation.Nullable Long tgMessageId) {
  ...
  public void setTgMessageId(@javax.annotation.Nullable Long tgMessageId) {
    this.tgMessageId = tgMessageId;
  }


  public TgMessageDTO tgUserId(@javax.annotation.Nullable Long tgUserId) {
  ...
  public void setTgUserId(@javax.annotation.Nullable Long tgUserId) {
    this.tgUserId = tgUserId;
  }


  public TgMessageDTO direction(@javax.annotation.Nullable String direction) {
  ...
  public TgMessageDTO messageType(@javax.annotation.Nullable String messageType) {
  ...
  public TgMessageDTO content(@javax.annotation.Nullable String content) {
  ...
  public TgMessageDTO payload(@javax.annotation.Nullable String payload) {
    this.payload = payload;
    return this;
  }

  /**
   * Raw telegram update payload (JSON)
   * @return payload
   */
  @javax.annotation.Nullable
   ...
   * @return the TgMessageDTO instance itself
   */
  public TgMessageDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TgMessageDTO tgMessageDTO = (TgMessageDTO) o;
    return Objects.equals(this.id, tgMessageDTO.id) &&
        Objects.equals(this.gmtCreate, tgMessageDTO.gmtCreate) &&
        Objects.equals(this.gmtModified, tgMessageDTO.gmtModified) &&
        Objects.equals(this.chatId, tgMessageDTO.chatId) &&
        Objects.equals(this.tgMessageId, tgMessageDTO.tgMessageId) &&
        Objects.equals(this.tgUserId, tgMessageDTO.tgUserId) &&
        Objects.equals(this.direction, tgMessageDTO.direction) &&
        Objects.equals(this.messageType, tgMessageDTO.messageType) &&
        Objects.equals(this.content, tgMessageDTO.content) &&
        Objects.equals(this.payload, tgMessageDTO.payload)&&
        Objects.equals(this.additionalProperties, tgMessageDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, gmtCreate, gmtModified, chatId, tgMessageId, tgUserId, direction, messageType, content, payload, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TgMessageDTO {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    gmtCreate: ").append(toIndentedString(gmtCreate)).append("\n");
    sb.append("    gmtModified: ").append(toIndentedString(gmtModified)).append("\n");
    sb.append("    chatId: ").append(toIndentedString(chatId)).append("\n");
    sb.append("    tgMessageId: ").append(toIndentedString(tgMessageId)).append("\n");
    sb.append("    tgUserId: ").append(toIndentedString(tgUserId)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "gmtCreate", "gmtModified", "chatId", "tgMessageId", "tgUserId", "direction", "messageType", "content", "payload"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TgMessageDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TgMessageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TgMessageDTO is not found in the empty JSON string", TgMessageDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("messageType") != null && !jsonObj.get("messageType").isJsonNull()) && !jsonObj.get("messageType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `messageType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("messageType").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TgMessageDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TgMessageDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TgMessageDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TgMessageDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<TgMessageDTO>() {
           @Override
           public void write(JsonWriter out, TgMessageDTO value) throws IOException {
           ...
           @Override
           public TgMessageDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TgMessageDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TgMessageDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TgMessageDTO
   * @throws IOException if the JSON string is invalid with respect to TgMessageDTO
   */
  public static TgMessageDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TgMessageDTO.class);
  }

  /**
   * Convert an instance of TgMessageDTO to an JSON string
   *
   * @return JSON string
   */
