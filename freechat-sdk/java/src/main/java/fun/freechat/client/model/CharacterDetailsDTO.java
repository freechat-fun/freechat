...
public class CharacterDetailsDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, characterId, characterUid, gmtCreate, gmtModified, parentUid, visibility, version, name, description, nickname, avatar, picture, gender, lang, greeting, username, tags, profile, chatStyle, chatExample, ext, draft, backends, additionalProperties);
  }
