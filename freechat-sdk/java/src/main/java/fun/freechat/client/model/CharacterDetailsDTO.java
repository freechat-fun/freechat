...
public class CharacterDetailsDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, characterId, gmtCreate, gmtModified, visibility, version, name, description, nickname, avatar, picture, gender, lang, username, tags, profile, greeting, chatStyle, chatExample, ext, draft, backends, additionalProperties);
  }
