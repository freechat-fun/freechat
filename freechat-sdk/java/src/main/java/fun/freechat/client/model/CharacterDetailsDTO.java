...
public class CharacterDetailsDTO {
  ...
  public CharacterDetailsDTO video(@javax.annotation.Nullable String video) {
    this.video = video;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, characterDetailsDTO.requestId) &&
        ...
        Objects.equals(this.video, characterDetailsDTO.video) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CharacterDetailsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CharacterDetailsDTO is not found in the empty JSON string", CharacterDetailsDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("backends") != null && !jsonObj.get("backends").isJsonNull()) {
        ...
        if (jsonArraybackends != null) {
          ...
          if (!jsonObj.get("backends").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `backends` to be an array in the JSON string but got `%s`", jsonObj.get("backends").toString()));
          }
