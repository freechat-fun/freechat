...
public class AppConfigForAdminApi {
     ...
     */
    public okhttp3.Call getAppConfigsCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/admin/app/configs";
    ...
    private okhttp3.Call getAppConfigsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAppConfigsCall(_callback);
     ...
     */
    public AppConfigInfoDTO getAppConfigs() throws ApiException {
        ApiResponse<AppConfigInfoDTO> localVarResp = getAppConfigsWithHttpInfo();
     ...
     */
    public ApiResponse<AppConfigInfoDTO> getAppConfigsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAppConfigsValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getAppConfigsAsync(final ApiCallback<AppConfigInfoDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAppConfigsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<AppConfigInfoDTO>(){}.getType();
