...
public class AppConfigForAdminApi {
    ...
    /**
     * Build call for getDefaultConfig
     ...
     */
    public okhttp3.Call getDefaultConfigCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/admin/app/configs/default";
    ...
    private okhttp3.Call getDefaultConfigValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getDefaultConfigCall(_callback);
     ...
     */
    public String getDefaultConfig() throws ApiException {
        ApiResponse<String> localVarResp = getDefaultConfigWithHttpInfo();
     ...
     */
    public ApiResponse<String> getDefaultConfigWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getDefaultConfigValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Default Config (asynchronously)
     * Get default configuration information of the application.
     ...
     */
    public okhttp3.Call getDefaultConfigAsync(final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDefaultConfigValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
