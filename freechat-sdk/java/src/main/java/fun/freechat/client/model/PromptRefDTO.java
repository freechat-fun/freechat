...
public class PromptRefDTO {
  ...
  public PromptRefDTO promptId(@javax.annotation.Nonnull Long promptId) {
  ...
  public void setPromptId(@javax.annotation.Nonnull Long promptId) {
    this.promptId = promptId;
  }


  public PromptRefDTO variables(@javax.annotation.Nullable Map<String, Object> variables) {
  ...
  public PromptRefDTO draft(@javax.annotation.Nullable Boolean draft) {
    this.draft = draft;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("promptId", "variables", "draft"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("promptId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptRefDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptRefDTO is not found in the empty JSON string", PromptRefDTO.openapiRequiredFields.toString()));
        }
      }
