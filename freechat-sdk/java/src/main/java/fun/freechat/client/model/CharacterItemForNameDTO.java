...
public class CharacterItemForNameDTO {
  ...
  public CharacterItemForNameDTO characterId(Long characterId) {
  ...
  public CharacterItemForNameDTO version(Integer version) {
  ...
  public CharacterItemForNameDTO stats(InteractiveStatsDTO stats) {
    this.stats = stats;
    return this;
  }
