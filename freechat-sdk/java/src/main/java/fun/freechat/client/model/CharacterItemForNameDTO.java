...
public class CharacterItemForNameDTO {
  ...
  public CharacterItemForNameDTO() {
  }

  public CharacterItemForNameDTO characterId(@javax.annotation.Nullable Long characterId) {
  ...
  public CharacterItemForNameDTO version(@javax.annotation.Nullable Integer version) {
  ...
  public CharacterItemForNameDTO stats(@javax.annotation.Nullable InteractiveStatsDTO stats) {
    this.stats = stats;
    return this;
  }
  ...
  public void setStats(@javax.annotation.Nullable InteractiveStatsDTO stats) {
    this.stats = stats;
  }
   ...
   * @return the CharacterItemForNameDTO instance itself
   */
  public CharacterItemForNameDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CharacterItemForNameDTO characterItemForNameDTO = (CharacterItemForNameDTO) o;
    return Objects.equals(this.characterId, characterItemForNameDTO.characterId) &&
        Objects.equals(this.version, characterItemForNameDTO.version) &&
        Objects.equals(this.stats, characterItemForNameDTO.stats)&&
        Objects.equals(this.additionalProperties, characterItemForNameDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(characterId, version, stats, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CharacterItemForNameDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("characterId", "version", "stats"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CharacterItemForNameDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CharacterItemForNameDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CharacterItemForNameDTO is not found in the empty JSON string", CharacterItemForNameDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CharacterItemForNameDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CharacterItemForNameDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CharacterItemForNameDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CharacterItemForNameDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<CharacterItemForNameDTO>() {
           @Override
           public void write(JsonWriter out, CharacterItemForNameDTO value) throws IOException {
           ...
           @Override
           public CharacterItemForNameDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CharacterItemForNameDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CharacterItemForNameDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CharacterItemForNameDTO
   * @throws IOException if the JSON string is invalid with respect to CharacterItemForNameDTO
   */
  public static CharacterItemForNameDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CharacterItemForNameDTO.class);
  }

  /**
   * Convert an instance of CharacterItemForNameDTO to an JSON string
   *
   * @return JSON string
   */
