...
public class PromptTemplateDTO {
  ...
  public PromptTemplateDTO template(@javax.annotation.Nullable String template) {
  ...
  public PromptTemplateDTO chatTemplate(@javax.annotation.Nullable ChatPromptContentDTO chatTemplate) {
  ...
  public PromptTemplateDTO variables(@javax.annotation.Nullable Map<String, Object> variables) {
  ...
  public PromptTemplateDTO format(@javax.annotation.Nullable String format) {
    this.format = format;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("template", "chatTemplate", "variables", "format"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptTemplateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptTemplateDTO is not found in the empty JSON string", PromptTemplateDTO.openapiRequiredFields.toString()));
        }
      }
