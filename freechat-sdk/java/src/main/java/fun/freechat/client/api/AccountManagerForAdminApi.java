...
public class AccountManagerForAdminApi {
     ...
     */
    public List<String> listTokensOfUser(String username) throws ApiException {
        ApiResponse<List<String>> localVarResp = listTokensOfUserWithHttpInfo(username);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> listTokensOfUserWithHttpInfo(String username) throws ApiException {
     ...
     */
    public okhttp3.Call listTokensOfUserAsync(String username, final ApiCallback<List<String>> _callback) throws ApiException {
