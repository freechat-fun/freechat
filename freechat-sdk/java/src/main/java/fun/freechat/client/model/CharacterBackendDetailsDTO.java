...
public class CharacterBackendDetailsDTO {
  ...
  public static final String SERIALIZED_NAME_TG_BOT_USERNAME = "tgBotUsername";
  @SerializedName(SERIALIZED_NAME_TG_BOT_USERNAME)
  @javax.annotation.Nullable
  private String tgBotUsername;

  public static final String SERIALIZED_NAME_TG_BOT_LINK = "tgBotLink";
  @SerializedName(SERIALIZED_NAME_TG_BOT_LINK)
  @javax.annotation.Nullable
  ...
  public CharacterBackendDetailsDTO moderationApiKeyValue(@javax.annotation.Nullable String moderationApiKeyValue) {
  ...
  public CharacterBackendDetailsDTO imageModelId(@javax.annotation.Nullable String imageModelId) {
  ...
  public CharacterBackendDetailsDTO imageApiKeyName(@javax.annotation.Nullable String imageApiKeyName) {
  ...
  public CharacterBackendDetailsDTO imageApiKeyValue(@javax.annotation.Nullable String imageApiKeyValue) {
  ...
  public CharacterBackendDetailsDTO imageParams(@javax.annotation.Nullable String imageParams) {
  ...
  public CharacterBackendDetailsDTO tgBotId(@javax.annotation.Nullable Long tgBotId) {
  ...
  public CharacterBackendDetailsDTO tgBotToken(@javax.annotation.Nullable String tgBotToken) {
  ...
  public CharacterBackendDetailsDTO tgBotUsername(@javax.annotation.Nullable String tgBotUsername) {
    this.tgBotUsername = tgBotUsername;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getTgBotUsername() {
    return tgBotUsername;
  }

  public void setTgBotUsername(@javax.annotation.Nullable String tgBotUsername) {
    this.tgBotUsername = tgBotUsername;
  }


  public CharacterBackendDetailsDTO tgBotLink(@javax.annotation.Nullable String tgBotLink) {
    this.tgBotLink = tgBotLink;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getTgBotLink() {
    return tgBotLink;
  }

  public void setTgBotLink(@javax.annotation.Nullable String tgBotLink) {
    this.tgBotLink = tgBotLink;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, characterBackendDetailsDTO.requestId) &&
        ...
        Objects.equals(this.moderationApiKeyValue, characterBackendDetailsDTO.moderationApiKeyValue) &&
        Objects.equals(this.moderationParams, characterBackendDetailsDTO.moderationParams) &&
        Objects.equals(this.imageModelId, characterBackendDetailsDTO.imageModelId) &&
        Objects.equals(this.imageApiKeyName, characterBackendDetailsDTO.imageApiKeyName) &&
        Objects.equals(this.imageApiKeyValue, characterBackendDetailsDTO.imageApiKeyValue) &&
        Objects.equals(this.imageParams, characterBackendDetailsDTO.imageParams) &&
  ...
  public String toString() {
    ...
    sb.append("    tgBotUsername: ").append(toIndentedString(tgBotUsername)).append("\n");
    sb.append("    tgBotLink: ").append(toIndentedString(tgBotLink)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "backendId", "gmtCreate", "gmtModified", "characterUid", "isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationApiKeyValue", "moderationParams", "imageModelId", "imageApiKeyName", "imageApiKeyValue", "imageParams", "messageWindowSize", "longTermMemoryWindowSize", "proactiveChatWaitingTime", "initQuota", "quotaType", "enableAlbumTool", "enableTts", "ttsSpeakerIdx", "ttsSpeakerWav", "ttsSpeakerType", "tgBotId", "tgBotToken", "tgBotUsername", "tgBotLink"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CharacterBackendDetailsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CharacterBackendDetailsDTO is not found in the empty JSON string", CharacterBackendDetailsDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("backendId") != null && !jsonObj.get("backendId").isJsonNull()) && !jsonObj.get("backendId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `backendId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("backendId").toString()));
      }
      if ((jsonObj.get("characterUid") != null && !jsonObj.get("characterUid").isJsonNull()) && !jsonObj.get("characterUid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `characterUid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("characterUid").toString()));
      }
      ...
      if ((jsonObj.get("tgBotUsername") != null && !jsonObj.get("tgBotUsername").isJsonNull()) && !jsonObj.get("tgBotUsername").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tgBotUsername` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tgBotUsername").toString()));
      }
      if ((jsonObj.get("tgBotLink") != null && !jsonObj.get("tgBotLink").isJsonNull()) && !jsonObj.get("tgBotLink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tgBotLink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tgBotLink").toString()));
      }
  }
