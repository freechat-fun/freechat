...
public class ChatSessionDTO {
  ...
  public ChatSessionDTO provider(String provider) {
    this.provider = provider;
    return this;
  }

  /**
   * Model provider: hugging_face | open_ai | azure_open_ai | local_ai | in_process | dash_scope | unknown
   * @return provider
   */
  @javax.annotation.Nullable
  ...
  public ChatSessionDTO proactiveChatWaitingTime(Integer proactiveChatWaitingTime) {
  ...
  public ChatSessionDTO isCustomizedApiKeyEnabled(Boolean isCustomizedApiKeyEnabled) {
  ...
  public void setIsCustomizedApiKeyEnabled(Boolean isCustomizedApiKeyEnabled) {
    this.isCustomizedApiKeyEnabled = isCustomizedApiKeyEnabled;
  }
