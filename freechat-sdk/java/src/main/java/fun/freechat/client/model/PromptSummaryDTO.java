...
public class PromptSummaryDTO {
  ...
  public PromptSummaryDTO() {
  }

  public PromptSummaryDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public PromptSummaryDTO promptId(@javax.annotation.Nullable Long promptId) {
  ...
  public void setPromptId(@javax.annotation.Nullable Long promptId) {
    this.promptId = promptId;
  }


  public PromptSummaryDTO promptUid(@javax.annotation.Nullable String promptUid) {
  ...
  public void setPromptUid(@javax.annotation.Nullable String promptUid) {
    this.promptUid = promptUid;
  }


  public PromptSummaryDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public PromptSummaryDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public PromptSummaryDTO parentUid(@javax.annotation.Nullable String parentUid) {
  ...
  public PromptSummaryDTO visibility(@javax.annotation.Nullable String visibility) {
  ...
  public PromptSummaryDTO version(@javax.annotation.Nullable Integer version) {
  ...
  public PromptSummaryDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PromptSummaryDTO type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public PromptSummaryDTO description(@javax.annotation.Nullable String description) {
  ...
  public PromptSummaryDTO format(@javax.annotation.Nullable String format) {
    this.format = format;
    return this;
  }
  ...
  public PromptSummaryDTO lang(@javax.annotation.Nullable String lang) {
    this.lang = lang;
    return this;
  }
  ...
  public PromptSummaryDTO username(@javax.annotation.Nullable String username) {
  ...
  public PromptSummaryDTO tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PromptSummaryDTO addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PromptSummaryDTO aiModels(@javax.annotation.Nullable List<AiModelInfoDTO> aiModels) {
    this.aiModels = aiModels;
    return this;
  }

  public PromptSummaryDTO addAiModelsItem(AiModelInfoDTO aiModelsItem) {
   ...
   * @return the PromptSummaryDTO instance itself
   */
  public PromptSummaryDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromptSummaryDTO promptSummaryDTO = (PromptSummaryDTO) o;
    return Objects.equals(this.requestId, promptSummaryDTO.requestId) &&
        Objects.equals(this.promptId, promptSummaryDTO.promptId) &&
        Objects.equals(this.promptUid, promptSummaryDTO.promptUid) &&
        Objects.equals(this.gmtCreate, promptSummaryDTO.gmtCreate) &&
        Objects.equals(this.gmtModified, promptSummaryDTO.gmtModified) &&
        Objects.equals(this.parentUid, promptSummaryDTO.parentUid) &&
        Objects.equals(this.visibility, promptSummaryDTO.visibility) &&
        Objects.equals(this.version, promptSummaryDTO.version) &&
        Objects.equals(this.name, promptSummaryDTO.name) &&
        Objects.equals(this.type, promptSummaryDTO.type) &&
        Objects.equals(this.description, promptSummaryDTO.description) &&
        Objects.equals(this.format, promptSummaryDTO.format) &&
        Objects.equals(this.lang, promptSummaryDTO.lang) &&
        Objects.equals(this.username, promptSummaryDTO.username) &&
        Objects.equals(this.tags, promptSummaryDTO.tags) &&
        Objects.equals(this.aiModels, promptSummaryDTO.aiModels)&&
        Objects.equals(this.additionalProperties, promptSummaryDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, promptId, promptUid, gmtCreate, gmtModified, parentUid, visibility, version, name, type, description, format, lang, username, tags, aiModels, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PromptSummaryDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "promptId", "promptUid", "gmtCreate", "gmtModified", "parentUid", "visibility", "version", "name", "type", "description", "format", "lang", "username", "tags", "aiModels"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromptSummaryDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptSummaryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptSummaryDTO is not found in the empty JSON string", PromptSummaryDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("promptUid") != null && !jsonObj.get("promptUid").isJsonNull()) && !jsonObj.get("promptUid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `promptUid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("promptUid").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromptSummaryDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromptSummaryDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromptSummaryDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromptSummaryDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PromptSummaryDTO>() {
           @Override
           public void write(JsonWriter out, PromptSummaryDTO value) throws IOException {
           ...
           @Override
           public PromptSummaryDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromptSummaryDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromptSummaryDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromptSummaryDTO
   * @throws IOException if the JSON string is invalid with respect to PromptSummaryDTO
   */
  public static PromptSummaryDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromptSummaryDTO.class);
  }

  /**
   * Convert an instance of PromptSummaryDTO to an JSON string
   *
   * @return JSON string
   */
