...
public class PromptSummaryDTO {
  ...
  public PromptSummaryDTO requestId(String requestId) {
  ...
  public PromptSummaryDTO promptId(Long promptId) {
  ...
  public PromptSummaryDTO promptUid(String promptUid) {
  ...
  public PromptSummaryDTO gmtCreate(OffsetDateTime gmtCreate) {
  ...
  public PromptSummaryDTO gmtModified(OffsetDateTime gmtModified) {
  ...
  public PromptSummaryDTO parentUid(String parentUid) {
  ...
  public PromptSummaryDTO visibility(String visibility) {
  ...
  public PromptSummaryDTO version(Integer version) {
  ...
  public PromptSummaryDTO name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PromptSummaryDTO type(String type) {
    this.type = type;
    return this;
  }
  ...
  public PromptSummaryDTO description(String description) {
  ...
  public PromptSummaryDTO format(String format) {
    this.format = format;
    return this;
  }
  ...
  public PromptSummaryDTO lang(String lang) {
    this.lang = lang;
    return this;
  }
  ...
  public PromptSummaryDTO username(String username) {
  ...
  public PromptSummaryDTO tags(List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public PromptSummaryDTO aiModels(List<AiModelInfoDTO> aiModels) {
