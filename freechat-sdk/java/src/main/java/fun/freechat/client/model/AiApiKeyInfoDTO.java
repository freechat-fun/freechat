...
public class AiApiKeyInfoDTO {
  ...
  public AiApiKeyInfoDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public AiApiKeyInfoDTO id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public AiApiKeyInfoDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public AiApiKeyInfoDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public AiApiKeyInfoDTO gmtUsed(@javax.annotation.Nullable OffsetDateTime gmtUsed) {
  ...
  public void setGmtUsed(@javax.annotation.Nullable OffsetDateTime gmtUsed) {
    this.gmtUsed = gmtUsed;
  }


  public AiApiKeyInfoDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AiApiKeyInfoDTO provider(@javax.annotation.Nullable String provider) {
  ...
  public AiApiKeyInfoDTO token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AiApiKeyInfoDTO enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public AiApiKeyInfoDTO username(@javax.annotation.Nullable String username) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "id", "gmtCreate", "gmtModified", "gmtUsed", "name", "provider", "token", "enabled", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiApiKeyInfoDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiApiKeyInfoDTO is not found in the empty JSON string", AiApiKeyInfoDTO.openapiRequiredFields.toString()));
        }
      }
