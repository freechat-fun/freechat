...
public class HotTagDTO {
  ...
  public HotTagDTO content(@javax.annotation.Nullable String content) {
  ...
  public HotTagDTO count(@javax.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
   ...
   * @return the HotTagDTO instance itself
   */
  public HotTagDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, hotTagDTO.content) &&
        Objects.equals(this.count, hotTagDTO.count)&&
        Objects.equals(this.additionalProperties, hotTagDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, count, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HotTagDTO {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "count"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to HotTagDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HotTagDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HotTagDTO is not found in the empty JSON string", HotTagDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HotTagDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HotTagDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HotTagDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HotTagDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<HotTagDTO>() {
           @Override
           public void write(JsonWriter out, HotTagDTO value) throws IOException {
           ...
           @Override
           public HotTagDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             HotTagDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of HotTagDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HotTagDTO
   * @throws IOException if the JSON string is invalid with respect to HotTagDTO
   */
  public static HotTagDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HotTagDTO.class);
  }

  /**
   * Convert an instance of HotTagDTO to an JSON string
   *
   * @return JSON string
   */
