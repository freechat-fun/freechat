...
public class PluginDetailsDTO {
  ...
  public PluginDetailsDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public PluginDetailsDTO pluginId(@javax.annotation.Nullable Long pluginId) {
  ...
  public PluginDetailsDTO pluginUid(@javax.annotation.Nullable String pluginUid) {
  ...
  public PluginDetailsDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public PluginDetailsDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public PluginDetailsDTO visibility(@javax.annotation.Nullable String visibility) {
  ...
  public PluginDetailsDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PluginDetailsDTO provider(@javax.annotation.Nullable String provider) {
  ...
  public PluginDetailsDTO manifestFormat(@javax.annotation.Nullable String manifestFormat) {
  ...
  public PluginDetailsDTO apiFormat(@javax.annotation.Nullable String apiFormat) {
  ...
  public PluginDetailsDTO username(@javax.annotation.Nullable String username) {
  ...
  public PluginDetailsDTO tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public PluginDetailsDTO aiModels(@javax.annotation.Nullable List<AiModelInfoDTO> aiModels) {
  ...
  public PluginDetailsDTO manifestInfo(@javax.annotation.Nullable String manifestInfo) {
  ...
  public PluginDetailsDTO apiInfo(@javax.annotation.Nullable String apiInfo) {
  ...
  public PluginDetailsDTO toolSpecFormat(@javax.annotation.Nullable String toolSpecFormat) {
  ...
  public void setToolSpecFormat(@javax.annotation.Nullable String toolSpecFormat) {
    this.toolSpecFormat = toolSpecFormat;
  }


  public PluginDetailsDTO toolSpecInfo(@javax.annotation.Nullable String toolSpecInfo) {
  ...
  public void setToolSpecInfo(@javax.annotation.Nullable String toolSpecInfo) {
    this.toolSpecInfo = toolSpecInfo;
  }


  public PluginDetailsDTO ext(@javax.annotation.Nullable String ext) {
    this.ext = ext;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "pluginId", "pluginUid", "gmtCreate", "gmtModified", "visibility", "name", "provider", "manifestFormat", "apiFormat", "username", "tags", "aiModels", "manifestInfo", "apiInfo", "toolSpecFormat", "toolSpecInfo", "ext"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PluginDetailsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PluginDetailsDTO is not found in the empty JSON string", PluginDetailsDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("pluginUid") != null && !jsonObj.get("pluginUid").isJsonNull()) && !jsonObj.get("pluginUid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `pluginUid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pluginUid").toString()));
      }
      ...
      if ((jsonObj.get("toolSpecFormat") != null && !jsonObj.get("toolSpecFormat").isJsonNull()) && !jsonObj.get("toolSpecFormat").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `toolSpecFormat` to be a primitive type in the JSON string but got `%s`", jsonObj.get("toolSpecFormat").toString()));
      }
      if ((jsonObj.get("toolSpecInfo") != null && !jsonObj.get("toolSpecInfo").isJsonNull()) && !jsonObj.get("toolSpecInfo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `toolSpecInfo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("toolSpecInfo").toString()));
      }
