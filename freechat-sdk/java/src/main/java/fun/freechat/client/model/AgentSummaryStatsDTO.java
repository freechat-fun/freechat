...
public class AgentSummaryStatsDTO {
  ...
  public AgentSummaryStatsDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public AgentSummaryStatsDTO agentId(@javax.annotation.Nullable Long agentId) {
  ...
  public AgentSummaryStatsDTO agentUid(@javax.annotation.Nullable String agentUid) {
  ...
  public AgentSummaryStatsDTO gmtCreate(@javax.annotation.Nullable OffsetDateTime gmtCreate) {
  ...
  public AgentSummaryStatsDTO gmtModified(@javax.annotation.Nullable OffsetDateTime gmtModified) {
  ...
  public AgentSummaryStatsDTO parentUid(@javax.annotation.Nullable String parentUid) {
  ...
  public AgentSummaryStatsDTO visibility(@javax.annotation.Nullable String visibility) {
  ...
  public AgentSummaryStatsDTO format(@javax.annotation.Nullable String format) {
    this.format = format;
    return this;
  }
  ...
  public AgentSummaryStatsDTO version(@javax.annotation.Nullable Integer version) {
  ...
  public AgentSummaryStatsDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentSummaryStatsDTO description(@javax.annotation.Nullable String description) {
  ...
  public AgentSummaryStatsDTO username(@javax.annotation.Nullable String username) {
  ...
  public AgentSummaryStatsDTO tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AgentSummaryStatsDTO aiModels(@javax.annotation.Nullable List<AiModelInfoDTO> aiModels) {
  ...
  public AgentSummaryStatsDTO viewCount(@javax.annotation.Nullable Long viewCount) {
  ...
  public AgentSummaryStatsDTO referCount(@javax.annotation.Nullable Long referCount) {
  ...
  public AgentSummaryStatsDTO recommendCount(@javax.annotation.Nullable Long recommendCount) {
  ...
  public AgentSummaryStatsDTO scoreCount(@javax.annotation.Nullable Long scoreCount) {
  ...
  public AgentSummaryStatsDTO score(@javax.annotation.Nullable Long score) {
    this.score = score;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "agentId", "agentUid", "gmtCreate", "gmtModified", "parentUid", "visibility", "format", "version", "name", "description", "username", "tags", "aiModels", "viewCount", "referCount", "recommendCount", "scoreCount", "score"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentSummaryStatsDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentSummaryStatsDTO is not found in the empty JSON string", AgentSummaryStatsDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("agentUid") != null && !jsonObj.get("agentUid").isJsonNull()) && !jsonObj.get("agentUid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `agentUid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("agentUid").toString()));
      }
      if ((jsonObj.get("parentUid") != null && !jsonObj.get("parentUid").isJsonNull()) && !jsonObj.get("parentUid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `parentUid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parentUid").toString()));
      }
      ...
      if (jsonObj.get("aiModels") != null && !jsonObj.get("aiModels").isJsonNull()) {
        ...
        if (jsonArrayaiModels != null) {
          ...
          if (!jsonObj.get("aiModels").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aiModels` to be an array in the JSON string but got `%s`", jsonObj.get("aiModels").toString()));
          }
