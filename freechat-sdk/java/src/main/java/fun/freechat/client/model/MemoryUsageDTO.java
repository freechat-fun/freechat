...
public class MemoryUsageDTO {
  ...
  public MemoryUsageDTO requestId(@javax.annotation.Nullable String requestId) {
  ...
  public MemoryUsageDTO messageUsage(@javax.annotation.Nullable Long messageUsage) {
  ...
  public void setMessageUsage(@javax.annotation.Nullable Long messageUsage) {
    this.messageUsage = messageUsage;
  }


  public MemoryUsageDTO tokenUsage(@javax.annotation.Nullable TokenUsageDTO tokenUsage) {
  ...
  public void setTokenUsage(@javax.annotation.Nullable TokenUsageDTO tokenUsage) {
    this.tokenUsage = tokenUsage;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requestId", "messageUsage", "tokenUsage"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MemoryUsageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MemoryUsageDTO is not found in the empty JSON string", MemoryUsageDTO.openapiRequiredFields.toString()));
        }
      }
