...
public class ChatUpdateDTO {
  ...
  public ChatUpdateDTO userNickname(@javax.annotation.Nullable String userNickname) {
  ...
  public ChatUpdateDTO userProfile(@javax.annotation.Nullable String userProfile) {
  ...
  public ChatUpdateDTO characterNickname(@javax.annotation.Nullable String characterNickname) {
  ...
  public ChatUpdateDTO about(@javax.annotation.Nullable String about) {
    this.about = about;
    return this;
  }
  ...
  public ChatUpdateDTO characterUid(@javax.annotation.Nonnull String characterUid) {
  ...
  public ChatUpdateDTO backendId(@javax.annotation.Nullable String backendId) {
  ...
  public ChatUpdateDTO apiKeyName(@javax.annotation.Nullable String apiKeyName) {
  ...
  public ChatUpdateDTO apiKeyValue(@javax.annotation.Nullable String apiKeyValue) {
  ...
  public ChatUpdateDTO ext(@javax.annotation.Nullable String ext) {
    this.ext = ext;
    return this;
  }
  ...
  public ChatUpdateDTO gmtRead(@javax.annotation.Nullable OffsetDateTime gmtRead) {
  ...
  public void setGmtRead(@javax.annotation.Nullable OffsetDateTime gmtRead) {
    this.gmtRead = gmtRead;
  }
   ...
   * @return the ChatUpdateDTO instance itself
   */
  public ChatUpdateDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChatUpdateDTO chatUpdateDTO = (ChatUpdateDTO) o;
    return Objects.equals(this.userNickname, chatUpdateDTO.userNickname) &&
        Objects.equals(this.userProfile, chatUpdateDTO.userProfile) &&
        Objects.equals(this.characterNickname, chatUpdateDTO.characterNickname) &&
        Objects.equals(this.about, chatUpdateDTO.about) &&
        Objects.equals(this.characterUid, chatUpdateDTO.characterUid) &&
        Objects.equals(this.backendId, chatUpdateDTO.backendId) &&
        Objects.equals(this.apiKeyName, chatUpdateDTO.apiKeyName) &&
        Objects.equals(this.apiKeyValue, chatUpdateDTO.apiKeyValue) &&
        Objects.equals(this.ext, chatUpdateDTO.ext) &&
        Objects.equals(this.gmtRead, chatUpdateDTO.gmtRead)&&
        Objects.equals(this.additionalProperties, chatUpdateDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userNickname, userProfile, characterNickname, about, characterUid, backendId, apiKeyName, apiKeyValue, ext, gmtRead, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("userNickname", "userProfile", "characterNickname", "about", "characterUid", "backendId", "apiKeyName", "apiKeyValue", "ext", "gmtRead"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("characterUid"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChatUpdateDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatUpdateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatUpdateDTO is not found in the empty JSON string", ChatUpdateDTO.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChatUpdateDTO.openapiRequiredFields) {
      ...
      if ((jsonObj.get("userNickname") != null && !jsonObj.get("userNickname").isJsonNull()) && !jsonObj.get("userNickname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `userNickname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("userNickname").toString()));
      }
      if ((jsonObj.get("userProfile") != null && !jsonObj.get("userProfile").isJsonNull()) && !jsonObj.get("userProfile").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `userProfile` to be a primitive type in the JSON string but got `%s`", jsonObj.get("userProfile").toString()));
      }
      if ((jsonObj.get("characterNickname") != null && !jsonObj.get("characterNickname").isJsonNull()) && !jsonObj.get("characterNickname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `characterNickname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("characterNickname").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChatUpdateDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChatUpdateDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChatUpdateDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChatUpdateDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<ChatUpdateDTO>() {
           @Override
           public void write(JsonWriter out, ChatUpdateDTO value) throws IOException {
           ...
           @Override
           public ChatUpdateDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ChatUpdateDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ChatUpdateDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChatUpdateDTO
   * @throws IOException if the JSON string is invalid with respect to ChatUpdateDTO
   */
  public static ChatUpdateDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChatUpdateDTO.class);
  }

  /**
   * Convert an instance of ChatUpdateDTO to an JSON string
   *
   * @return JSON string
   */
