...
public class PromptQueryDTO {
  ...
  public PromptQueryDTO where(@javax.annotation.Nullable PromptQueryWhere where) {
    this.where = where;
    return this;
  }
  ...
  public void setWhere(@javax.annotation.Nullable PromptQueryWhere where) {
    this.where = where;
  }


  public PromptQueryDTO orderBy(@javax.annotation.Nullable List<String> orderBy) {
  ...
  public void setOrderBy(@javax.annotation.Nullable List<String> orderBy) {
    this.orderBy = orderBy;
  }


  public PromptQueryDTO pageNum(@javax.annotation.Nullable Long pageNum) {
  ...
  public void setPageNum(@javax.annotation.Nullable Long pageNum) {
    this.pageNum = pageNum;
  }


  public PromptQueryDTO pageSize(@javax.annotation.Nullable Long pageSize) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("where", "orderBy", "pageNum", "pageSize"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptQueryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptQueryDTO is not found in the empty JSON string", PromptQueryDTO.openapiRequiredFields.toString()));
        }
      }
