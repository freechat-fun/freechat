...
public class AgentQueryWhere {
  ...
  public AgentQueryWhere visibility(@javax.annotation.Nullable String visibility) {
  ...
  public AgentQueryWhere username(@javax.annotation.Nullable String username) {
  ...
  public AgentQueryWhere format(@javax.annotation.Nullable String format) {
    this.format = format;
    return this;
  }
  ...
  public AgentQueryWhere tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AgentQueryWhere tagsOp(@javax.annotation.Nullable String tagsOp) {
    this.tagsOp = tagsOp;
    return this;
  }
  ...
  public AgentQueryWhere aiModels(@javax.annotation.Nullable List<String> aiModels) {
  ...
  public AgentQueryWhere aiModelsOp(@javax.annotation.Nullable String aiModelsOp) {
  ...
  public AgentQueryWhere name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentQueryWhere text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("visibility", "username", "format", "tags", "tagsOp", "aiModels", "aiModelsOp", "name", "text"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentQueryWhere.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentQueryWhere is not found in the empty JSON string", AgentQueryWhere.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("tagsOp") != null && !jsonObj.get("tagsOp").isJsonNull()) && !jsonObj.get("tagsOp").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tagsOp` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tagsOp").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("aiModelsOp") != null && !jsonObj.get("aiModelsOp").isJsonNull()) && !jsonObj.get("aiModelsOp").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aiModelsOp` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aiModelsOp").toString()));
      }
