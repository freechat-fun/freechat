...
public class TokenUsageDTO {
  ...
  static {
    ...
    openapiFields.add("inputTokenCount");
    openapiFields.add("outputTokenCount");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenUsageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenUsageDTO is not found in the empty JSON string", TokenUsageDTO.openapiRequiredFields.toString()));
        }
      }
