...
public class TokenUsageDTO {
  public static final String SERIALIZED_NAME_INPUT_TOKEN_COUNT = "inputTokenCount";
  @SerializedName(SERIALIZED_NAME_INPUT_TOKEN_COUNT)
  @javax.annotation.Nullable
  private Integer inputTokenCount;

  public static final String SERIALIZED_NAME_OUTPUT_TOKEN_COUNT = "outputTokenCount";
  @SerializedName(SERIALIZED_NAME_OUTPUT_TOKEN_COUNT)
  @javax.annotation.Nullable
  ...
  public TokenUsageDTO inputTokenCount(@javax.annotation.Nullable Integer inputTokenCount) {
  ...
  public void setInputTokenCount(@javax.annotation.Nullable Integer inputTokenCount) {
    this.inputTokenCount = inputTokenCount;
  }


  public TokenUsageDTO outputTokenCount(@javax.annotation.Nullable Integer outputTokenCount) {
  ...
  public void setOutputTokenCount(@javax.annotation.Nullable Integer outputTokenCount) {
    this.outputTokenCount = outputTokenCount;
  }


  public TokenUsageDTO totalTokenCount(@javax.annotation.Nullable Integer totalTokenCount) {
  ...
  public void setTotalTokenCount(@javax.annotation.Nullable Integer totalTokenCount) {
    this.totalTokenCount = totalTokenCount;
  }
   ...
   * @return the TokenUsageDTO instance itself
   */
  public TokenUsageDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TokenUsageDTO tokenUsageDTO = (TokenUsageDTO) o;
    return Objects.equals(this.inputTokenCount, tokenUsageDTO.inputTokenCount) &&
        Objects.equals(this.outputTokenCount, tokenUsageDTO.outputTokenCount) &&
        Objects.equals(this.totalTokenCount, tokenUsageDTO.totalTokenCount)&&
        Objects.equals(this.additionalProperties, tokenUsageDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inputTokenCount, outputTokenCount, totalTokenCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TokenUsageDTO {\n");
    sb.append("    inputTokenCount: ").append(toIndentedString(inputTokenCount)).append("\n");
    sb.append("    outputTokenCount: ").append(toIndentedString(outputTokenCount)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("inputTokenCount", "outputTokenCount", "totalTokenCount"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TokenUsageDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenUsageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TokenUsageDTO is not found in the empty JSON string", TokenUsageDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenUsageDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenUsageDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenUsageDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenUsageDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenUsageDTO>() {
           @Override
           public void write(JsonWriter out, TokenUsageDTO value) throws IOException {
           ...
           @Override
           public TokenUsageDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TokenUsageDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TokenUsageDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TokenUsageDTO
   * @throws IOException if the JSON string is invalid with respect to TokenUsageDTO
   */
  public static TokenUsageDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenUsageDTO.class);
  }

  /**
   * Convert an instance of TokenUsageDTO to an JSON string
   *
   * @return JSON string
   */
