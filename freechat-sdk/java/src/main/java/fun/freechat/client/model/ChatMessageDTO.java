...
public class ChatMessageDTO {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("thinking") != null && !jsonObj.get("thinking").isJsonNull()) && !jsonObj.get("thinking").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `thinking` to be a primitive type in the JSON string but got `%s`", jsonObj.get("thinking").toString()));
      }
