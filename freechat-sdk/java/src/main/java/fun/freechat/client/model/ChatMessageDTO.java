...
public class ChatMessageDTO {
  ...
  public ChatMessageDTO role(@javax.annotation.Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public ChatMessageDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ChatMessageDTO contents(@javax.annotation.Nullable List<ChatContentDTO> contents) {
  ...
  public void setContents(@javax.annotation.Nullable List<ChatContentDTO> contents) {
    this.contents = contents;
  }


  public ChatMessageDTO toolCalls(@javax.annotation.Nullable List<ChatToolCallDTO> toolCalls) {
  ...
  public void setToolCalls(@javax.annotation.Nullable List<ChatToolCallDTO> toolCalls) {
    this.toolCalls = toolCalls;
  }


  public ChatMessageDTO thinking(@javax.annotation.Nullable String thinking) {
  ...
  public ChatMessageDTO context(@javax.annotation.Nullable String context) {
  ...
  public ChatMessageDTO messageId(@javax.annotation.Nullable Long messageId) {
  ...
  public void setMessageId(@javax.annotation.Nullable Long messageId) {
    this.messageId = messageId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.role, chatMessageDTO.role) &&
        ...
        Objects.equals(this.thinking, chatMessageDTO.thinking) &&
        Objects.equals(this.context, chatMessageDTO.context) &&
        Objects.equals(this.messageId, chatMessageDTO.messageId)&&
        Objects.equals(this.additionalProperties, chatMessageDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(role, name, contents, toolCalls, thinking, context, messageId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("role", "name", "contents", "toolCalls", "thinking", "context", "messageId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatMessageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatMessageDTO is not found in the empty JSON string", ChatMessageDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("thinking") != null && !jsonObj.get("thinking").isJsonNull()) && !jsonObj.get("thinking").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `thinking` to be a primitive type in the JSON string but got `%s`", jsonObj.get("thinking").toString()));
      }
