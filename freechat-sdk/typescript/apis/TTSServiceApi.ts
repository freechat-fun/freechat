 ...
 * no description
 */
export class TTSServiceApiRequestFactory extends BaseAPIRequestFactory {

    /**
     * Return builtin TTS speakers.
     * List Builtin Speakers
     */
    public async listTtsBuiltinSpeakers(_options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async playSample(speakerType: string, speaker: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async speakMessage(messageId: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class TTSServiceApiResponseProcessor {
     ...
     */
     public async listTtsBuiltinSpeakersWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<string> >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async playSampleWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async speakMessageWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
