 ...
 * no description
 */
export class AIManagerForBizAdminApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createOrUpdateAiModelInfo(aiModelInfoUpdateDTO: AiModelInfoUpdateDTO, _options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async deleteAiModelInfo(modelId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AIManagerForBizAdminApiResponseProcessor {
     ...
     */
     public async createOrUpdateAiModelInfoWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteAiModelInfoWithHttpInfo(response: ResponseContext): Promise<HttpInfo<boolean >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
