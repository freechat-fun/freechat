...
class PromptDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "promptId", "gmtCreate", "gmtModified", "visibility", "version", "name", "type", "description", "format", "lang", "username", "tags", "aiModels", "template", "chatTemplate", "example", "inputs", "ext", "draft"]
