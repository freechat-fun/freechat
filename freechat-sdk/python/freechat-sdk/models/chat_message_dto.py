...
class ChatMessageDTO(BaseModel):
    ...
    tool_call: Optional[ChatToolCallDTO] = Field(default=None, alias="toolCall")
    gmt_create: Optional[datetime] = Field(default=None, description="Creation time", alias="gmtCreate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["role", "name", "content", "toolCall", "gmtCreate"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "toolCall": ChatToolCallDTO.from_dict(obj.get("toolCall")) if obj.get("toolCall") is not None else None,
