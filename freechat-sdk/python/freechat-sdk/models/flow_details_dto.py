...
class FlowDetailsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["requestId", "flowId", "gmtCreate", "gmtModified", "parentId", "visibility", "format", "version", "name", "description", "username", "tags", "aiModels", "config", "example", "parameters", "ext", "draft"]
