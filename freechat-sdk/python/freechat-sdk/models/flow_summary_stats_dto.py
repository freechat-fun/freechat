...
class FlowSummaryStatsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["requestId", "flowId", "gmtCreate", "gmtModified", "parentId", "visibility", "format", "version", "name", "description", "username", "tags", "aiModels", "viewCount", "referCount", "recommendCount", "scoreCount", "score"]
