...
class CharacterItemForNameDTO(BaseModel):
    ...
    """ # noqa: E501
    character_id: Optional[StrictStr] = Field(default=None, description="characterId", alias="characterId")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stats": InteractiveStatsDTO.from_dict(obj.get("stats")) if obj.get("stats") is not None else None
        })
