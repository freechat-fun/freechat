...
class FlowItemForNameDTO(BaseModel):
    """
    Flow identifier and version information
    """ # noqa: E501
    flow_id: Optional[StrictStr] = Field(default=None, description="flowId", alias="flowId")
    version: Optional[StrictInt] = Field(default=None, description="version")
    stats: Optional[InteractiveStatsDTO] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["flowId", "version", "stats"]
