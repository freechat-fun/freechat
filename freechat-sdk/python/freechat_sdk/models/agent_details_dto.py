...
class AgentDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "agentId", "gmtCreate", "gmtModified", "parentId", "visibility", "format", "version", "name", "description", "username", "tags", "aiModels", "config", "example", "parameters", "ext", "draft"]
