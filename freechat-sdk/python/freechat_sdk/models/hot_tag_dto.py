...
class HotTagDTO(BaseModel):
    """
    Hot tag
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="Tag content")
    count: Optional[StrictInt] = Field(default=None, description="Tag count")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["content", "count"]
