...
class CharacterSummaryStatsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "characterId", "gmtCreate", "gmtModified", "visibility", "version", "name", "description", "nickname", "avatar", "picture", "gender", "lang", "username", "tags", "viewCount", "referCount", "recommendCount", "scoreCount", "score"]
