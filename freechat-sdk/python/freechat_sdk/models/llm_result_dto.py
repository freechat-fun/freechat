...
class LlmResultDTO(BaseModel):
    ...
    text: Optional[StrictStr] = Field(default=None, description="Model response content, the complete content is included in non-streaming responses; only the delta content is included in streaming responses (the complete content of streaming responses is in the content of the last frame message field)")
    message: Optional[ChatMessageDTO] = Field(default=None, description="Chat response message (usually as assistant, sometimes tool_call)")
    finish_reason: Optional[StrictStr] = Field(default=None, description="Model end reason: stop | length | tool_execution | content_filter", alias="finishReason")
    token_usage: Optional[TokenUsageDTO] = Field(default=None, description="Token usage information", alias="tokenUsage")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "text", "message", "finishReason", "tokenUsage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "message": ChatMessageDTO.from_dict(obj["message"]) if obj.get("message") is not None else None,
