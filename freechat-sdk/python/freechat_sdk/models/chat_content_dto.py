...
class ChatContentDTO(BaseModel):
    ...
    Chat content
    """ # noqa: E501
    type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Chat type: text (default) | image")
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"text|image", value):
            raise ValueError(r"must validate the regular expression /text|image/")
        return value
