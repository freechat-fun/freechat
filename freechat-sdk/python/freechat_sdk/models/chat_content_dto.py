...
class ChatContentDTO(BaseModel):
    ...
    Chat content
    """ # noqa: E501
    type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Chat type: text (default) | image | video | audio | pdf | ...")
    content: StrictStr = Field(description="Chat content(for image, it might be a normal url or data url)")
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"text|image|video|audio|pdf|...", value):
            raise ValueError(r"must validate the regular expression /text|image|video|audio|pdf|.../")
        return value
