...
class PromptQueryDTO(BaseModel):
    ...
    """ # noqa: E501
    where: Optional[PromptQueryWhere] = Field(default=None, description="Query condition")
    order_by: Optional[List[StrictStr]] = Field(default=None, description="Sorting condition, supported sorting fields are: - version - modifyTime - createTime - (interactive statistical fields)  Sorting priority follows the list order, default is descending, if ascending is expected, it needs to be specified after the field, such as: orderBy: [\\\"score\\\", \\\"scoreCount asc\\\"] (scoreCount in ascending order) ", alias="orderBy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "where": PromptQueryWhere.from_dict(obj["where"]) if obj.get("where") is not None else None,
