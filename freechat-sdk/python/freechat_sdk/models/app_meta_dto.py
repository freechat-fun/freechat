...
class AppMetaDTO(BaseModel):
    ...
    build_timestamp: Optional[StrictStr] = Field(default=None, description="Build time", alias="buildTimestamp")
    build_number: Optional[StrictStr] = Field(default=None, description="Build number", alias="buildNumber")
    commit_url: Optional[StrictStr] = Field(default=None, description="Commit URL", alias="commitUrl")
    release_note_url: Optional[StrictStr] = Field(default=None, description="Release notes", alias="releaseNoteUrl")
    running_env: Optional[StrictStr] = Field(default=None, description="Running environment", alias="runningEnv")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "version", "buildTimestamp", "buildNumber", "commitUrl", "releaseNoteUrl", "runningEnv"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "releaseNoteUrl": obj.get("releaseNoteUrl"),
            "runningEnv": obj.get("runningEnv")
        })
