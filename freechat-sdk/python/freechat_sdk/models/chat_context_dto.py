...
class ChatContextDTO(BaseModel):
    ...
    quota: Optional[StrictInt] = Field(default=None, description="Quota of this chat")
    ...
    __properties: ClassVar[List[str]] = ["requestId", "chatId", "gmtCreate", "gmtModified", "gmtRead", "userNickname", "userProfile", "characterNickname", "about", "backendId", "apiKeyName", "apiKeyValue", "quota", "quotaType", "ext"]
