...
class PromptRefDTO(BaseModel):
    """
    Prompt reference information
    """ # noqa: E501
    prompt_id: StrictInt = Field(description="Prompt identifier", alias="promptId")
    variables: Optional[Dict[str, Any]] = Field(default=None, description="Variables applied to the template, can be empty")
    draft: Optional[StrictBool] = Field(default=None, description="Whether to use draft content")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["promptId", "variables", "draft"]
