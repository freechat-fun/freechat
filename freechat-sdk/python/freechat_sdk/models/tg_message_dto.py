...
class TgMessageDTO(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Record identifier")
    ...
    chat_id: Optional[StrictStr] = Field(default=None, description="Related tg_chat.chat_id", alias="chatId")
    tg_message_id: Optional[StrictInt] = Field(default=None, description="Telegram message id", alias="tgMessageId")
    tg_user_id: Optional[StrictInt] = Field(default=None, description="Sender telegram user id", alias="tgUserId")
    direction: Optional[StrictStr] = Field(default=None, description="Direction: in | out")
    message_type: Optional[StrictStr] = Field(default=None, description="Message type", alias="messageType")
    content: Optional[StrictStr] = Field(default=None, description="Plain text content")
    payload: Optional[StrictStr] = Field(default=None, description="Raw telegram update payload (JSON)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "gmtCreate", "gmtModified", "chatId", "tgMessageId", "tgUserId", "direction", "messageType", "content", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tgMessageId": obj.get("tgMessageId"),
            "tgUserId": obj.get("tgUserId"),
