...
class CharacterDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "characterId", "characterUid", "gmtCreate", "gmtModified", "parentUid", "visibility", "version", "name", "description", "nickname", "avatar", "picture", "gender", "lang", "greeting", "defaultScene", "priority", "username", "tags", "profile", "chatStyle", "chatExample", "ext", "draft", "backends"]
