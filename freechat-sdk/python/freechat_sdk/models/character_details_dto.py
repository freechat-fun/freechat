...
class CharacterDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "characterId", "gmtCreate", "gmtModified", "visibility", "version", "name", "description", "nickname", "avatar", "picture", "gender", "lang", "username", "tags", "profile", "greeting", "chatStyle", "chatExample", "ext", "draft", "backends"]
