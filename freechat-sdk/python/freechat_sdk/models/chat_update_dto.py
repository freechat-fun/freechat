...
class ChatUpdateDTO(BaseModel):
    ...
    character_uid: StrictStr = Field(description="Character uid for this session", alias="characterUid")
    backend_id: Optional[StrictStr] = Field(default=None, description="Character backend for this session", alias="backendId")
    ...
    __properties: ClassVar[List[str]] = ["userNickname", "userProfile", "characterNickname", "about", "characterUid", "backendId", "apiKeyName", "apiKeyValue", "ext", "gmtRead"]
