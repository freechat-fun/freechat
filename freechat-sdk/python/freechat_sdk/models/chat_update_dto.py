...
class ChatUpdateDTO(BaseModel):
    ...
    character_id: StrictInt = Field(description="Character id for this session", alias="characterId")
    ...
    __properties: ClassVar[List[str]] = ["userNickname", "userProfile", "characterNickname", "about", "characterId", "backendId", "apiKeyName", "apiKeyValue", "ext", "gmtRead"]
