...
class ChatMessageRecordDTO(BaseModel):
    """
    Chat message record
    """ # noqa: E501
    message: Optional[ChatMessageDTO] = Field(default=None, description="Message")
    gmt_create: Optional[datetime] = Field(default=None, description="Creation time", alias="gmtCreate")
    ext: Optional[StrictStr] = Field(default=None, description="Additional information")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "gmtCreate", "ext"]
