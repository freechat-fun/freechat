...
class RagTaskDTO(BaseModel):
    """
    RAG task information
    """ # noqa: E501
    source_type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Source type: file (default) | url", alias="sourceType")
    source: Optional[StrictStr] = Field(default=None, description="Source information, url, or a key for file")
    max_segment_size: Optional[StrictInt] = Field(default=None, description="The maximum size of a segment in tokens.", alias="maxSegmentSize")
    max_overlap_size: Optional[StrictInt] = Field(default=None, description="The maximum size of the overlap between segments in tokens.", alias="maxOverlapSize")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sourceType", "source", "maxSegmentSize", "maxOverlapSize"]
    ...
    def source_type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"file|url", value):
            raise ValueError(r"must validate the regular expression /file|url/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxSegmentSize": obj.get("maxSegmentSize"),
            "maxOverlapSize": obj.get("maxOverlapSize")
        })
