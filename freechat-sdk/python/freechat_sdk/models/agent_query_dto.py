...
class AgentQueryDTO(BaseModel):
    ...
    """ # noqa: E501
    where: Optional[AgentQueryWhere] = Field(default=None, description="Query condition")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "where": AgentQueryWhere.from_dict(obj["where"]) if obj.get("where") is not None else None,
