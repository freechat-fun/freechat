...
class TokenUsageDTO(BaseModel):
    ...
    """ # noqa: E501
    input_token_count: Optional[StrictInt] = Field(default=None, description="Input token count", alias="inputTokenCount")
    output_token_count: Optional[StrictInt] = Field(default=None, description="Output token count", alias="outputTokenCount")
    total_token_count: Optional[StrictInt] = Field(default=None, description="Total token count", alias="totalTokenCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inputTokenCount", "outputTokenCount", "totalTokenCount"]
