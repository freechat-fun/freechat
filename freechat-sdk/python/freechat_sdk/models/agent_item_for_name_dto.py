...
class AgentItemForNameDTO(BaseModel):
    """
    Agent identifier and version information
    """ # noqa: E501
    agent_id: Optional[StrictInt] = Field(default=None, description="agentId", alias="agentId")
    ...
    __properties: ClassVar[List[str]] = ["agentId", "version", "stats"]
