...
class PromptAiParamDTO(BaseModel):
    ...
    prompt_template: Optional[PromptTemplateDTO] = Field(default=None, description="Prompt template content", alias="promptTemplate")
    prompt_ref: Optional[PromptRefDTO] = Field(default=None, description="Prompt reference information", alias="promptRef")
    params: Dict[str, Any] = Field(description="Model call parameters, the actual supported fields are related to modelId, depending on the model provider, specific fields can refer to: OpenAiParamDTO, QwenParamDTO")
