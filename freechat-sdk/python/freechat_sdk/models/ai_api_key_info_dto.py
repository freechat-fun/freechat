...
class AiApiKeyInfoDTO(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="Credential identifier")
    ...
    gmt_used: Optional[datetime] = Field(default=None, description="Last use time", alias="gmtUsed")
    name: Optional[StrictStr] = Field(default=None, description="Credential name")
    provider: Optional[StrictStr] = Field(default=None, description="Model provider: hugging_face | open_ai | azure_open_ai | dash_scope | ollama | unknown")
    token: Optional[StrictStr] = Field(default=None, description="Credential content")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether to enable")
    username: Optional[StrictStr] = Field(default=None, description="Credential owner")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "id", "gmtCreate", "gmtModified", "gmtUsed", "name", "provider", "token", "enabled", "username"]
