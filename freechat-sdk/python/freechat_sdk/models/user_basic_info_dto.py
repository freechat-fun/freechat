...
class UserBasicInfoDTO(BaseModel):
    """
    ...
    nickname: Optional[StrictStr] = Field(default=None, description="Nickname")
    picture: Optional[StrictStr] = Field(default=None, description="Avatar")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "username", "nickname", "picture"]
