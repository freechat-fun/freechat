...
class PluginSummaryDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "pluginId", "pluginUid", "gmtCreate", "gmtModified", "visibility", "name", "provider", "manifestFormat", "apiFormat", "username", "tags", "aiModels"]
