...
class AiApiKeyCreateDTO(BaseModel):
    """
    Request data for adding new model credential information
    """ # noqa: E501
    name: StrictStr = Field(description="Credential name")
    provider: Annotated[str, Field(strict=True)] = Field(description="Model provider: hugging_face | open_ai | azure_open_ai | dash_scope | ollama | unknown")
    token: StrictStr = Field(description="Credential content")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether to enable (enabled by default)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "provider", "token", "enabled"]
