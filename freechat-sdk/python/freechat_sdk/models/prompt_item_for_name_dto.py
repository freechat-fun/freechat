...
class PromptItemForNameDTO(BaseModel):
    """
    Prompt identifier and version information
    """ # noqa: E501
    prompt_id: Optional[StrictInt] = Field(default=None, description="promptId", alias="promptId")
    ...
    __properties: ClassVar[List[str]] = ["promptId", "version", "stats"]
