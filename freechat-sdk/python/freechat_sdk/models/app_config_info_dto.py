...
class AppConfigInfoDTO(BaseModel):
    """
    ...
    format: Optional[StrictStr] = Field(default=None, description="Configuration format: kv | json | yaml")
    content: Optional[StrictStr] = Field(default=None, description="Configuration content")
    version: Optional[StrictInt] = Field(default=None, description="Configuration version")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "name", "format", "content", "version"]
