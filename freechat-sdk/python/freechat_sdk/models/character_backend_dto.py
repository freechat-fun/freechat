...
class CharacterBackendDTO(BaseModel):
    ...
    moderation_api_key_value: Optional[StrictStr] = Field(default=None, description="Api key value for moderation model", alias="moderationApiKeyValue")
    ...
    image_model_id: Optional[StrictStr] = Field(default=None, description="Image model for the character", alias="imageModelId")
    image_api_key_name: Optional[StrictStr] = Field(default=None, description="Api key name for image model", alias="imageApiKeyName")
    image_api_key_value: Optional[StrictStr] = Field(default=None, description="Api key value for image model", alias="imageApiKeyValue")
    image_params: Optional[StrictStr] = Field(default=None, description="Parameters for image model", alias="imageParams")
    ...
    long_term_memory_window_size: Optional[StrictInt] = Field(default=None, description="Max rounds (a round includes a user message and a character reply) in the character's long term memory, 0 to disable", alias="longTermMemoryWindowSize")
    proactive_chat_waiting_time: Optional[StrictInt] = Field(default=None, description="Minutes to wait for a proactive chat", alias="proactiveChatWaitingTime")
    init_quota: Optional[StrictInt] = Field(default=None, description="Initial quota when opening a chat", alias="initQuota")
    quota_type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Quota type: messages | tokens | none (not limited)", alias="quotaType")
    enable_album_tool: Optional[StrictBool] = Field(default=None, description="Enable character album image retrieval tool", alias="enableAlbumTool")
    enable_tts: Optional[StrictBool] = Field(default=None, description="Enable character tts feature", alias="enableTts")
    tts_speaker_idx: Optional[StrictStr] = Field(default=None, description="Character's speaker idx for tts", alias="ttsSpeakerIdx")
    tts_speaker_wav: Optional[StrictStr] = Field(default=None, description="Character's speaker sample for tts", alias="ttsSpeakerWav")
    tts_speaker_type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Character's speaker type for tts: idx | wav", alias="ttsSpeakerType")
    tg_bot_id: Optional[StrictInt] = Field(default=None, description="Telegram-assigned bot id (parsed from token prefix; derived server-side if omitted)", alias="tgBotId")
    tg_bot_token: Optional[StrictStr] = Field(default=None, description="Telegram bot token issued by BotFather (format: '<bot_id>:<secret>')", alias="tgBotToken")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationApiKeyValue", "moderationParams", "imageModelId", "imageApiKeyName", "imageApiKeyValue", "imageParams", "messageWindowSize", "longTermMemoryWindowSize", "proactiveChatWaitingTime", "initQuota", "quotaType", "enableAlbumTool", "enableTts", "ttsSpeakerIdx", "ttsSpeakerWav", "ttsSpeakerType", "tgBotId", "tgBotToken"]

    @field_validator('quota_type')
    def quota_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value

        if not re.match(r"messages|tokens|none", value):
            raise ValueError(r"must validate the regular expression /messages|tokens|none/")
        return value

    @field_validator('tts_speaker_type')
    def tts_speaker_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value

        if not re.match(r"idx|wav", value):
            raise ValueError(r"must validate the regular expression /idx|wav/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "moderationApiKeyValue": obj.get("moderationApiKeyValue"),
            "moderationParams": obj.get("moderationParams"),
            "imageModelId": obj.get("imageModelId"),
            "imageApiKeyName": obj.get("imageApiKeyName"),
            "imageApiKeyValue": obj.get("imageApiKeyValue"),
            "imageParams": obj.get("imageParams"),
            "messageWindowSize": obj.get("messageWindowSize"),
            "longTermMemoryWindowSize": obj.get("longTermMemoryWindowSize"),
            "proactiveChatWaitingTime": obj.get("proactiveChatWaitingTime"),
            "initQuota": obj.get("initQuota"),
            "quotaType": obj.get("quotaType"),
            "enableAlbumTool": obj.get("enableAlbumTool"),
            "enableTts": obj.get("enableTts"),
            "ttsSpeakerIdx": obj.get("ttsSpeakerIdx"),
            "ttsSpeakerWav": obj.get("ttsSpeakerWav"),
            "ttsSpeakerType": obj.get("ttsSpeakerType"),
            "tgBotId": obj.get("tgBotId"),
            "tgBotToken": obj.get("tgBotToken")
        })
