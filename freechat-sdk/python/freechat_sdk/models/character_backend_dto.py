...
class CharacterBackendDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationParams", "messageWindowSize", "longTermMemoryWindowSize", "proactiveChatWaitingTime", "initQuota", "quotaType", "enableAlbumTool"]
