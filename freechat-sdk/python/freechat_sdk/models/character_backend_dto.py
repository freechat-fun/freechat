...
class CharacterBackendDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationParams", "messageWindowSize", "longTermMemoryWindowSize", "initQuota", "quotaType"]
