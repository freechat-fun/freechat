...
class CharacterBackendDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationParams", "messageWindowSize", "initQuota", "quotaType", "forwardToUser"]
