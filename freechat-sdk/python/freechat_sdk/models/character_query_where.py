...
class CharacterQueryWhere(BaseModel):
    ...
    text: Optional[StrictStr] = Field(default=None, description="Name, description, profile, chat style, experience, fuzzy match, any one match is sufficient; public scope + general search for all users does not guarantee real-time.")
