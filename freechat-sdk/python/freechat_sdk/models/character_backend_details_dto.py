...
class CharacterBackendDetailsDTO(BaseModel):
    ...
    long_term_memory_window_size: Optional[StrictInt] = Field(default=None, description="Max rounds (a round includes a user message and a character reply) in the character's long term memory", alias="longTermMemoryWindowSize")
    ...
    quota_type: Optional[StrictStr] = Field(default=None, description="Quota type: messages | tokens | none (not limited)", alias="quotaType")
    ...
    tts_speaker_type: Optional[StrictStr] = Field(default=None, description="Character's speaker type for tts: idx | wav", alias="ttsSpeakerType")
    tg_bot_id: Optional[StrictInt] = Field(default=None, description="Telegram-assigned bot id", alias="tgBotId")
    tg_bot_token: Optional[StrictStr] = Field(default=None, description="Telegram bot token issued by BotFather", alias="tgBotToken")
    tg_bot_username: Optional[StrictStr] = Field(default=None, description="Telegram bot username resolved via getMe (null when bot not active)", alias="tgBotUsername")
    tg_bot_link: Optional[StrictStr] = Field(default=None, description="Telegram invite link in the form https://t.me/<username> (null when bot not active)", alias="tgBotLink")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "backendId", "gmtCreate", "gmtModified", "characterUid", "isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationApiKeyValue", "moderationParams", "imageModelId", "imageApiKeyName", "imageApiKeyValue", "imageParams", "messageWindowSize", "longTermMemoryWindowSize", "proactiveChatWaitingTime", "initQuota", "quotaType", "enableAlbumTool", "enableTts", "ttsSpeakerIdx", "ttsSpeakerWav", "ttsSpeakerType", "tgBotId", "tgBotToken", "tgBotUsername", "tgBotLink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tgBotUsername": obj.get("tgBotUsername"),
            "tgBotLink": obj.get("tgBotLink")
        })
