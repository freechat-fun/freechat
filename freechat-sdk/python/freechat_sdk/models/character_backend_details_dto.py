...
class CharacterBackendDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "backendId", "gmtCreate", "gmtModified", "characterUid", "isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationParams", "messageWindowSize", "longTermMemoryWindowSize", "initQuota", "quotaType"]
