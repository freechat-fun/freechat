...
class CharacterBackendDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "backendId", "gmtCreate", "gmtModified", "characterUid", "isDefault", "chatPromptTaskId", "greetingPromptTaskId", "moderationModelId", "moderationApiKeyName", "moderationParams", "messageWindowSize", "initQuota", "quotaType", "forwardToUser"]
