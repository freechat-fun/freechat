...
class RagTaskDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "id", "gmtCreate", "gmtModified", "gmtStart", "gmtEnd", "characterUid", "sourceType", "source", "maxSegmentSize", "maxOverlapSize", "status", "ext"]
