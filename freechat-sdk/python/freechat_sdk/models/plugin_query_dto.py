...
class PluginQueryDTO(BaseModel):
    ...
    """ # noqa: E501
    where: Optional[PluginQueryWhere] = Field(default=None, description="Query condition")
    ...
    page_size: Optional[StrictInt] = Field(default=None, description="Page item count, 1～50, default is 10", alias="pageSize")
