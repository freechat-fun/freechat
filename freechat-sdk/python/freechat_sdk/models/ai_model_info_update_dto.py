...
class AiModelInfoUpdateDTO(BaseModel):
    """
    ...
    type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Model type: text2text | text2chat | text2image | embedding | moderation")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "provider", "type"]
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"text2text|text2chat|text2image|embedding|moderation", value):
            raise ValueError(r"must validate the regular expression /text2text|text2chat|text2image|embedding|moderation/")
        return value
