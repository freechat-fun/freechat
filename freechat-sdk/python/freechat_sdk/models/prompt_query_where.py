...
class PromptQueryWhere(BaseModel):
    """
    Query condition
    """ # noqa: E501
    ...
    tags_op: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Relationship between tags: and | or (default)", alias="tagsOp")
    ai_models: Optional[List[StrictStr]] = Field(default=None, description="Model set", alias="aiModels")
    ai_models_op: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Relationship between model sets: and | or (default)", alias="aiModelsOp")
    name: Optional[StrictStr] = Field(default=None, description="Name, left match")
    type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Type, exact match: string (default) | chat")
    ...
    @field_validator('tags_op')
    def tags_op_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value

        if not re.match(r"and|or", value):
            raise ValueError(r"must validate the regular expression /and|or/")
        return value

    @field_validator('ai_models_op')
    def ai_models_op_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"string|chat", value):
            raise ValueError(r"must validate the regular expression /string|chat/")
        return value
