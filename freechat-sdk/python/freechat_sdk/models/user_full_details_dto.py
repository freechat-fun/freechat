...
class UserFullDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "username", "nickname", "givenName", "middleName", "familyName", "preferredUsername", "profile", "picture", "website", "email", "gender", "birthdate", "zoneinfo", "locale", "phoneNumber", "updatedAt", "platform", "enabled", "locked", "expiresAt", "passwordExpiresAt", "address", "password"]
