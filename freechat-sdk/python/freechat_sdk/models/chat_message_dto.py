...
class ChatMessageDTO(BaseModel):
    ...
    context: Optional[StrictStr] = Field(default=None, description="Contextual information in this round of conversation")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["role", "name", "contents", "toolCalls", "gmtCreate", "context"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "role": obj.get("role"),
            "name": obj.get("name"),
            "contents": [ChatContentDTO.from_dict(_item) for _item in obj.get("contents")] if obj.get("contents") is not None else None,
