...
class ChatMessageDTO(BaseModel):
    ...
    Chat message
    """ # noqa: E501
    role: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Chat role: system | assistant | user | tool_call | tool_result")
    ...
    thinking: Optional[StrictStr] = Field(default=None, description="Thinking information")
    ...
    message_id: Optional[StrictInt] = Field(default=None, description="Message identifier", alias="messageId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["role", "name", "contents", "toolCalls", "thinking", "context", "messageId"]
    ...
    def role_validate_regular_expression(cls, value):
        ...
        if not re.match(r"system|assistant|user|tool_call|tool_result", value):
            raise ValueError(r"must validate the regular expression /system|assistant|user|tool_call|tool_result/")
        return value
