...
class PluginSummaryStatsDTO(BaseModel):
    ...
    plugin_id: Optional[StrictInt] = Field(default=None, description="Plugin identifier", alias="pluginId")
    plugin_uid: Optional[StrictStr] = Field(default=None, description="Plugin immutable identifier", alias="pluginUid")
    ...
    __properties: ClassVar[List[str]] = ["requestId", "pluginId", "pluginUid", "gmtCreate", "gmtModified", "visibility", "name", "provider", "manifestFormat", "apiFormat", "username", "tags", "aiModels", "viewCount", "referCount", "recommendCount", "scoreCount", "score"]
