...
class ChatPromptContentDTO(BaseModel):
    ...
    message_to_send: Optional[ChatMessageDTO] = Field(default=None, description="Chat new message template (usually as user role)", alias="messageToSend")
    messages: Optional[List[ChatMessageDTO]] = Field(default=None, description="Pre-set chat messages in the Prompt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["system", "messageToSend", "messages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of message_to_send
        if self.message_to_send:
            _dict['messageToSend'] = self.message_to_send.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageToSend": ChatMessageDTO.from_dict(obj["messageToSend"]) if obj.get("messageToSend") is not None else None,
