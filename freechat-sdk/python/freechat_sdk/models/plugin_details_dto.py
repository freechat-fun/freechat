...
class PluginDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "pluginId", "pluginUid", "gmtCreate", "gmtModified", "visibility", "name", "provider", "manifestFormat", "apiFormat", "username", "tags", "aiModels", "manifestInfo", "apiInfo", "toolSpecFormat", "toolSpecInfo", "ext"]
