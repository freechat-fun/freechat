...
class MemoryUsageDTO(BaseModel):
    ...
    message_usage: Optional[StrictInt] = Field(default=None, description="Messages usage information", alias="messageUsage")
    token_usage: Optional[TokenUsageDTO] = Field(default=None, description="Token usage information", alias="tokenUsage")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "messageUsage", "tokenUsage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageUsage": obj.get("messageUsage"),
