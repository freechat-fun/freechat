...
class CharacterItemForNameDTO(BaseModel):
    """
    Character identifier and version information
    """ # noqa: E501
    character_id: Optional[StrictInt] = Field(default=None, description="characterId", alias="characterId")
    version: Optional[StrictInt] = Field(default=None, description="version")
    stats: Optional[InteractiveStatsDTO] = Field(default=None, description="Interactive statistics information")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["characterId", "version", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": InteractiveStatsDTO.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
