...
class PromptDetailsDTO(BaseModel):
    ...
    template: Optional[StrictStr] = Field(default=None, description="Prompt text template content")
    chat_template: Optional[ChatPromptContentDTO] = Field(default=None, description="Prompt chat template content", alias="chatTemplate")
    example: Optional[StrictStr] = Field(default=None, description="Prompt example")
    inputs: Optional[StrictStr] = Field(default=None, description="Prompt inputs, JSON format")
    ...
    __properties: ClassVar[List[str]] = ["requestId", "promptId", "promptUid", "gmtCreate", "gmtModified", "parentUid", "visibility", "version", "name", "type", "description", "format", "lang", "username", "tags", "aiModels", "template", "chatTemplate", "example", "inputs", "ext", "draft"]
