...
class AgentSummaryStatsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["requestId", "agentId", "agentUid", "gmtCreate", "gmtModified", "parentUid", "visibility", "format", "version", "name", "description", "username", "tags", "aiModels", "viewCount", "referCount", "recommendCount", "scoreCount", "score"]
