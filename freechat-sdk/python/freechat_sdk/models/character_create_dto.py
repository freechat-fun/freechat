...
class CharacterCreateDTO(BaseModel):
    ...
    video: Optional[StrictStr] = Field(default=None, description="Character video url")
    gender: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Character gender: male | female | other")
    ...
    __properties: ClassVar[List[str]] = ["parentUid", "visibility", "name", "description", "nickname", "avatar", "picture", "video", "gender", "profile", "greeting", "chatStyle", "chatExample", "defaultScene", "lang", "ext", "draft", "tags"]
    ...
    def gender_validate_regular_expression(cls, value):
        ...
        if not re.match(r"male|female|other", value):
            raise ValueError(r"must validate the regular expression /male|female|other/")
        return value
