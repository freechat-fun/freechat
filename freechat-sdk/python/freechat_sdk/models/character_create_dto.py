...
class CharacterCreateDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["parentId", "visibility", "name", "description", "nickname", "avatar", "picture", "gender", "profile", "greeting", "chatStyle", "chatExample", "lang", "ext", "draft", "tags"]
