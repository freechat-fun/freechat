...
class ChatSessionDTO(BaseModel):
    ...
    provider: Optional[StrictStr] = Field(default=None, description="Model provider: hugging_face | open_ai | azure_open_ai | local_ai | in_process | dash_scope | unknown")
    ...
    __properties: ClassVar[List[str]] = ["context", "character", "provider", "latestMessageRecord", "proactiveChatWaitingTime", "senderStatus", "isDebugEnabled", "isCustomizedApiKeyEnabled"]
