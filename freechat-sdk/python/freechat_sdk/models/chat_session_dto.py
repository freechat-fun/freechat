...
class ChatSessionDTO(BaseModel):
    ...
    Chat session
    """ # noqa: E501
    context: Optional[ChatContextDTO] = Field(default=None, description="Chat context")
    character: Optional[CharacterSummaryDTO] = Field(default=None, description="Character summary info")
    provider: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Model provider: hugging_face | open_ai | azure_open_ai | dash_scope | ollama | unknown")
    latest_message_record: Optional[ChatMessageRecordDTO] = Field(default=None, description="Latest message record", alias="latestMessageRecord")
    ...
    sender_status: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Sender status: online | offline | invisible", alias="senderStatus")
    is_debug_enabled: Optional[StrictBool] = Field(default=None, description="Is it possible to debug", alias="isDebugEnabled")
    is_customized_api_key_enabled: Optional[StrictBool] = Field(default=None, description="Is it possible to customize api-key", alias="isCustomizedApiKeyEnabled")
    is_tts_enabled: Optional[StrictBool] = Field(default=None, description="Enable character tts feature or not", alias="isTtsEnabled")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["context", "character", "provider", "latestMessageRecord", "proactiveChatWaitingTime", "senderStatus", "isDebugEnabled", "isCustomizedApiKeyEnabled", "isTtsEnabled"]
    ...
    def provider_validate_regular_expression(cls, value):
        ...
        if not re.match(r"hugging_face|open_ai|azure_open_ai|dash_scope|ollama|unknown", value):
            raise ValueError(r"must validate the regular expression /hugging_face|open_ai|azure_open_ai|dash_scope|ollama|unknown/")
        return value

    @field_validator('sender_status')
    def sender_status_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value

        if not re.match(r"online|offline|invisible", value):
            raise ValueError(r"must validate the regular expression /online|offline|invisible/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isCustomizedApiKeyEnabled": obj.get("isCustomizedApiKeyEnabled"),
            "isTtsEnabled": obj.get("isTtsEnabled")
        })
