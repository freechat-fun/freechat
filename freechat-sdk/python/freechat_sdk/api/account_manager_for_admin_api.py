...
class AccountManagerForAdminApi:
    ...
    def _create_token_for_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/admin/token/{username}/{duration}',
    ...
    def _create_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/admin/user',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_token_for_user(
        self,
        token: Annotated[str, Field(min_length=1, strict=True, description="API Token")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_token_for_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/admin/token/{token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/admin/user/{username}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_user_by_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/tokenBy/{token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_authorities_of_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/authority/{username}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_tokens_of_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/token/{username}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_users_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/users/{pageSize}/{pageNum}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_users1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_users2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/users/{pageSize}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
