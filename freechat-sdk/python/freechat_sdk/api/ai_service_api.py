...
class AIServiceApi:
    ...
    def _add_ai_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/ai/apikey',
    ...
    def delete_ai_api_key(
        self,
        id: Annotated[int, Field(strict=True, gt=0, description="Credential identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_ai_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/ai/apikey/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _disable_ai_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/ai/apikey/disable/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _enable_ai_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/ai/apikey/enable/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_ai_api_keys(
        self,
        provider: Annotated[str, Field(min_length=1, strict=True, description="Model provider")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _list_ai_api_keys_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/ai/apikeys/{provider}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
