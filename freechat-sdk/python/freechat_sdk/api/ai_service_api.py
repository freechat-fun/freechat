...
class AIServiceApi:
    ...
    def _get_ai_model_info_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/public/ai/model/{modelId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_ai_model_info_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/public/ai/models',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_ai_model_info1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/public/ai/models/{pageSize}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_ai_model_info2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/public/ai/models/{pageSize}/{pageNum}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
