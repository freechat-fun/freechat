...
class TelegramManagerForAdminApi:
    ...
    @validate_call
    def find_telegram_chat(
        self,
        backend_id: Annotated[str, Field(min_length=1, strict=True, description="Character backend identifier")],
        tg_chat_id: Annotated[StrictInt, Field(description="Telegram chat id")],
        ...
        :param backend_id: Character backend identifier (required)
        :type backend_id: str
        :param tg_chat_id: Telegram chat id (required)
        :type tg_chat_id: int
        ...
        _param = self._find_telegram_chat_serialize(
    ...
    @validate_call
    def find_telegram_chat_with_http_info(
        self,
        backend_id: Annotated[str, Field(min_length=1, strict=True, description="Character backend identifier")],
        tg_chat_id: Annotated[StrictInt, Field(description="Telegram chat id")],
        _request_timeout: Union[
    ...
    @validate_call
    def find_telegram_chat_without_preload_content(
        self,
        backend_id: Annotated[str, Field(min_length=1, strict=True, description="Character backend identifier")],
        tg_chat_id: Annotated[StrictInt, Field(description="Telegram chat id")],
        _request_timeout: Union[
    ...
    def _find_telegram_chat_serialize(
        self,
        backend_id,
        tg_chat_id,
        _request_auth,
        ...
        if tg_chat_id is not None:
            _path_params['tgChatId'] = tg_chat_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/chat/tg/{backendId}/{tgChatId}',
    ...
    def list_telegram_messages(
        self,
        chat_id: Annotated[str, Field(min_length=1, strict=True, description="tg_chat.chat_id")],
        limit: Annotated[Optional[StrictInt], Field(description="Max rows to return (default 100)")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Row offset (default 0)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param chat_id: tg_chat.chat_id (required)
        :type chat_id: str
        ...
        _param = self._list_telegram_messages_serialize(
            chat_id=chat_id,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_telegram_messages_with_http_info(
        self,
        chat_id: Annotated[str, Field(min_length=1, strict=True, description="tg_chat.chat_id")],
        limit: Annotated[Optional[StrictInt], Field(description="Max rows to return (default 100)")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Row offset (default 0)")] = None,
    ...
    @validate_call
    def list_telegram_messages_without_preload_content(
        self,
        chat_id: Annotated[str, Field(min_length=1, strict=True, description="tg_chat.chat_id")],
        limit: Annotated[Optional[StrictInt], Field(description="Max rows to return (default 100)")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Row offset (default 0)")] = None,
    ...
    def _list_telegram_messages_serialize(
        self,
        chat_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/admin/chat/tg/messages/{chatId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
