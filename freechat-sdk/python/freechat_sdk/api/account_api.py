...
class AccountApi:
    ...
    def _create_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/account/token/{duration}',
    ...
    def _create_token1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/account/token',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_token(
        self,
        token: Annotated[str, Field(min_length=1, strict=True, description="Token content")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/account/token/{token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_token_by_id(
        self,
        id: Annotated[int, Field(strict=True, gt=0, description="Token id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_token_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/account/token/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_user_basic_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/account/basic/{username}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_user_basic1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/account/basic',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_user_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/account/details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_tokens_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/account/tokens',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_user_picture(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="User picture")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _upload_user_picture_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/account/picture',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
