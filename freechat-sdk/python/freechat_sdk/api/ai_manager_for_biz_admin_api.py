...
class AIManagerForBizAdminApi:
    ...
    @validate_call
    def create_or_update_ai_model_info(
        self,
        ai_model_info_update_dto: Annotated[AiModelInfoUpdateDTO, Field(description="Model information")],
        ...
        :param ai_model_info_update_dto: Model information (required)
        :type ai_model_info_update_dto: AiModelInfoUpdateDTO
        ...
        _param = self._create_or_update_ai_model_info_serialize(
            ai_model_info_update_dto=ai_model_info_update_dto,
    ...
    @validate_call
    def create_or_update_ai_model_info_with_http_info(
        self,
        ai_model_info_update_dto: Annotated[AiModelInfoUpdateDTO, Field(description="Model information")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_or_update_ai_model_info_without_preload_content(
        self,
        ai_model_info_update_dto: Annotated[AiModelInfoUpdateDTO, Field(description="Model information")],
        _request_timeout: Union[
            None,
    ...
    def _create_or_update_ai_model_info_serialize(
        self,
        ai_model_info_update_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if ai_model_info_update_dto is not None:
            _body_params = ai_model_info_update_dto
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/biz/admin/ai/model',
    ...
    def delete_ai_model_info(
        ...
        _param = self._delete_ai_model_info_serialize(
            model_id=model_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_ai_model_info_with_http_info(
        self,
        model_id: Annotated[StrictStr, Field(description="Model identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_ai_model_info_without_preload_content(
        self,
        model_id: Annotated[StrictStr, Field(description="Model identifier")],
        _request_timeout: Union[
            None,
    ...
    def _delete_ai_model_info_serialize(
        self,
        model_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/biz/admin/ai/model/{modelId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
