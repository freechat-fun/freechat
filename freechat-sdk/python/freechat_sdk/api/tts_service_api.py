...
class TTSServiceApi:
    ...
    def list_tts_builtin_speakers(
        ...
        _param = self._list_tts_builtin_speakers_serialize(
    ...
    @validate_call
    def list_tts_builtin_speakers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_tts_builtin_speakers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_tts_builtin_speakers_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/public/tts/builtin/speakers',
    ...
    def play_sample(
        self,
        speaker_type: Annotated[str, Field(strict=True, description="The speaker type")],
        speaker: Annotated[str, Field(min_length=1, strict=True, description="The speaker")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param speaker_type: The speaker type (required)
        :type speaker_type: str
        ...
        _param = self._play_sample_serialize(
    ...
    @validate_call
    def play_sample_with_http_info(
        self,
        speaker_type: Annotated[str, Field(strict=True, description="The speaker type")],
        speaker: Annotated[str, Field(min_length=1, strict=True, description="The speaker")],
        _request_timeout: Union[
    ...
    @validate_call
    def play_sample_without_preload_content(
        self,
        speaker_type: Annotated[str, Field(strict=True, description="The speaker type")],
        speaker: Annotated[str, Field(min_length=1, strict=True, description="The speaker")],
        _request_timeout: Union[
    ...
    def _play_sample_serialize(
        ...
        if speaker_type is not None:
            _path_params['speakerType'] = speaker_type
        if speaker is not None:
            _path_params['speaker'] = speaker
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/public/tts/play/sample/{speakerType}/{speaker}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def speak_message(
        self,
        message_id: Annotated[int, Field(strict=True, gt=0, description="The message id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._speak_message_serialize(
    ...
    @validate_call
    def speak_message_with_http_info(
        self,
        message_id: Annotated[int, Field(strict=True, gt=0, description="The message id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def speak_message_without_preload_content(
        self,
        message_id: Annotated[int, Field(strict=True, gt=0, description="The message id")],
        _request_timeout: Union[
            None,
    ...
    def _speak_message_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/tts/speak/{messageId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
