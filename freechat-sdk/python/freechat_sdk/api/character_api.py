...
class CharacterApi:
    ...
    def _count_public_characters_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/public/character/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _export_character_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/character/export/{characterId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _import_character_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/character/import',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _search_public_character_summary_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/public/character/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
