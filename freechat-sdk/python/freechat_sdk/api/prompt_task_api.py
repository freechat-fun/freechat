...
class PromptTaskApi:
    ...
    def create_prompt_task(
        self,
        prompt_task_dto: Annotated[PromptTaskDTO, Field(description="The prompt task to be added")],
        ...
        :param prompt_task_dto: The prompt task to be added (required)
        :type prompt_task_dto: PromptTaskDTO
        ...
        _param = self._create_prompt_task_serialize(
            prompt_task_dto=prompt_task_dto,
    ...
    @validate_call
    def create_prompt_task_with_http_info(
        self,
        prompt_task_dto: Annotated[PromptTaskDTO, Field(description="The prompt task to be added")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_prompt_task_without_preload_content(
        self,
        prompt_task_dto: Annotated[PromptTaskDTO, Field(description="The prompt task to be added")],
        _request_timeout: Union[
            None,
    ...
    def _create_prompt_task_serialize(
        self,
        prompt_task_dto,
        _request_auth,
        _content_type,
        ...
        if prompt_task_dto is not None:
            _body_params = prompt_task_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/prompt/task',
    ...
    @validate_call
    def delete_prompt_task(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param prompt_task_id: The promptTaskId to be deleted (required)
        :type prompt_task_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_prompt_task_serialize(
    ...
    @validate_call
    def delete_prompt_task_with_http_info(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be deleted")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_prompt_task_without_preload_content(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be deleted")],
        _request_timeout: Union[
            None,
    ...
    def _delete_prompt_task_serialize(
        self,
        prompt_task_id,
        _request_auth,
        _content_type,
        ...
        if prompt_task_id is not None:
            _path_params['promptTaskId'] = prompt_task_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/prompt/task/{promptTaskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_prompt_task(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be queried")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param prompt_task_id: The promptTaskId to be queried (required)
        :type prompt_task_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_prompt_task_serialize(
            prompt_task_id=prompt_task_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_prompt_task_with_http_info(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be queried")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PromptTaskDetailsDTO]:
        """Get Prompt Task
    ...
    @validate_call
    def get_prompt_task_without_preload_content(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be queried")],
        _request_timeout: Union[
            None,
    ...
    def _get_prompt_task_serialize(
        self,
        prompt_task_id,
        _request_auth,
        _content_type,
    ...
    def update_prompt_task(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be updated")],
        prompt_task_dto: Annotated[PromptTaskDTO, Field(description="The prompt task info to be updated")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param prompt_task_id: The promptTaskId to be updated (required)
        :type prompt_task_id: str
        :param prompt_task_dto: The prompt task info to be updated (required)
        :type prompt_task_dto: PromptTaskDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_prompt_task_serialize(
            prompt_task_id=prompt_task_id,
            prompt_task_dto=prompt_task_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_prompt_task_with_http_info(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be updated")],
        prompt_task_dto: Annotated[PromptTaskDTO, Field(description="The prompt task info to be updated")],
        _request_timeout: Union[
    ...
    @validate_call
    def update_prompt_task_without_preload_content(
        self,
        prompt_task_id: Annotated[str, Field(min_length=1, strict=True, description="The promptTaskId to be updated")],
        prompt_task_dto: Annotated[PromptTaskDTO, Field(description="The prompt task info to be updated")],
        _request_timeout: Union[
    ...
    def _update_prompt_task_serialize(
        self,
        prompt_task_id,
        prompt_task_dto,
        _request_auth,
