...
class PromptTaskApi:
    ...
    def _create_prompt_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/prompt/task',
    ...
    def delete_prompt_task(
        self,
        prompt_task_id: Annotated[StrictStr, Field(description="The promptTaskId to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_prompt_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/prompt/task/{promptTaskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_prompt_task(
        self,
        prompt_task_id: Annotated[StrictStr, Field(description="The promptTaskId to be queried")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_prompt_task(
        self,
        prompt_task_id: Annotated[StrictStr, Field(description="The promptTaskId to be updated")],
