...
class RagApi:
    ...
    def cancel_rag_task(
        self,
        task_id: Annotated[int, Field(strict=True, gt=0, description="The taskId to be canceled")],
    ...
    def _cancel_rag_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/rag/task/cancel/{taskId}',
    ...
    def create_rag_task(
        self,
        character_uid: Annotated[str, Field(min_length=1, strict=True, description="The characterUid to be added a RAG task")],
        ...
        :param character_uid: The characterUid to be added a RAG task (required)
    ...
    def _create_rag_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/rag/task/{characterUid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_rag_task(
        self,
        task_id: Annotated[int, Field(strict=True, gt=0, description="The taskId to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_rag_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/rag/task/{taskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_rag_task(
        self,
        task_id: Annotated[int, Field(strict=True, gt=0, description="The taskId to be queried")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_rag_task_status(
        self,
        task_id: Annotated[int, Field(strict=True, gt=0, description="The taskId to be queried status")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_rag_task_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/rag/task/status/{taskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_rag_tasks_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/rag/tasks/{characterUid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def start_rag_task(
        self,
        task_id: Annotated[int, Field(strict=True, gt=0, description="The taskId to be started")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _start_rag_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/rag/task/start/{taskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_rag_task(
        self,
        task_id: Annotated[int, Field(strict=True, gt=0, description="The taskId to be updated")],
