...
class OrganizationApi:
    ...
    def _get_owners_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/owners',
    ...
    def _get_owners_dot_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/owners/dot',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_subordinate_owners(
        self,
        username: Annotated[str, Field(min_length=1, strict=True, description="The account being queried, must be a subordinate account of the current account")],
        all: Annotated[Optional[StrictStr], Field(description="Whether to return virtual reported owners")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_subordinate_owners_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/manage/{username}/owners',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_subordinate_subordinates_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/manage/{username}/subordinates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_subordinates_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/subordinates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_subordinates_dot_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/subordinates/dot',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_subordinate_authorities(
        self,
        username: Annotated[str, Field(min_length=1, strict=True, description="Username")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _list_subordinate_authorities_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/org/authority/{username}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_subordinate_subordinates_tree(
        self,
        username: Annotated[str, Field(min_length=1, strict=True, description="The account being operated, must be a subordinate account of the current account")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
