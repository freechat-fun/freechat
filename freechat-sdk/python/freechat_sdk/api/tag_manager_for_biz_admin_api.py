...
class TagManagerForBizAdminApi:
    ...
    def create_tag(
        self,
        refer_type: Annotated[str, Field(min_length=1, strict=True, description="Tag type (prompt, agent, plugin...)")],
        refer_id: Annotated[str, Field(min_length=1, strict=True, description="Resource identifier of the tag")],
        tag: Annotated[str, Field(min_length=1, strict=True, description="Tag content")],
        ...
        :param refer_type: Tag type (prompt, agent, plugin...) (required)
        :type refer_type: str
        :param refer_id: Resource identifier of the tag (required)
        :type refer_id: str
    ...
    def _create_tag_serialize(
        ...
        if refer_type is not None:
            _path_params['referType'] = refer_type
        if refer_id is not None:
            _path_params['referId'] = refer_id
        if tag is not None:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/biz/admin/tag/{referType}/{referId}/{tag}',
