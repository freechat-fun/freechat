...
class TagManagerForBizAdminApi:
    ...
    def create_tag(
        self,
        refer_type: Annotated[StrictStr, Field(description="Tag type (prompt, agent, plugin...)")],
        refer_id: Annotated[StrictStr, Field(description="Resource identifier of the tag")],
        tag: Annotated[StrictStr, Field(description="Tag content")],
