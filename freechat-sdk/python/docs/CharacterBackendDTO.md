...
**moderation_api_key_value** | **str** | Api key value for moderation model | [optional] 
**moderation_params** | **str** | Parameters for moderation model | [optional] 
**image_model_id** | **str** | Image model for the character | [optional] 
**image_api_key_name** | **str** | Api key name for image model | [optional] 
**image_api_key_value** | **str** | Api key value for image model | [optional] 
**image_params** | **str** | Parameters for image model | [optional] 
