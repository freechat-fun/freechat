...
class TestChatPromptContentDTO(unittest.TestCase):
    """ChatPromptContentDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatPromptContentDTO:
        """Test ChatPromptContentDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatPromptContentDTO`
        """
        model = ChatPromptContentDTO()
        if include_optional:
            return ChatPromptContentDTO(
                system = '',
    ...
    def testChatPromptContentDTO(self):
        """Test ChatPromptContentDTO"""
