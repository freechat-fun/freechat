...
class TestFlowSummaryDTO(unittest.TestCase):
    """FlowSummaryDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowSummaryDTO:
        """Test FlowSummaryDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowSummaryDTO`
        """
        model = FlowSummaryDTO()
        if include_optional:
