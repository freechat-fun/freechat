...
class TestPromptSummaryDTO(unittest.TestCase):
    """PromptSummaryDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromptSummaryDTO:
        """Test PromptSummaryDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromptSummaryDTO`
        """
        model = PromptSummaryDTO()
        if include_optional:
