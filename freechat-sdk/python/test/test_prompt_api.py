...
class TestPromptApi(unittest.TestCase):
    ...
    def test_count_public_prompts(self) -> None:
        """Test case for count_public_prompts
    ...
    def test_search_public_prompt_summary(self) -> None:
        """Test case for search_public_prompt_summary
