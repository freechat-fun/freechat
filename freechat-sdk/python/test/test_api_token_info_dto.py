...
class TestApiTokenInfoDTO(unittest.TestCase):
    """ApiTokenInfoDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTokenInfoDTO:
        """Test ApiTokenInfoDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTokenInfoDTO`
        """
        model = ApiTokenInfoDTO()
        if include_optional:
            return ApiTokenInfoDTO(
                request_id = '',
                id = 56,
