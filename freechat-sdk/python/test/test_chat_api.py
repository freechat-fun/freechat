...
class TestChatApi(unittest.TestCase):
    ...
    def test_list_debug_messages(self) -> None:
        """Test case for list_debug_messages

        List Chat Debug Messages
        """
        pass

    def test_list_debug_messages1(self) -> None:
        """Test case for list_debug_messages1

        List Chat Debug Messages
        """
        pass

    def test_list_debug_messages2(self) -> None:
        """Test case for list_debug_messages2
    ...
    def test_send_assistant(self) -> None:
        """Test case for send_assistant
    ...
    def test_stream_send_assistant(self) -> None:
        """Test case for stream_send_assistant
