...
CREATE TABLE IF NOT EXISTS `prompt_info` (
  ...
  `visibility` varchar(12) DEFAULT 'private',
  `name` varchar(128) NOT NULL,
  `type` varchar(12) DEFAULT 'string' COMMENT 'string | chat',
  `description` text DEFAULT NULL,
  `template` text DEFAULT NULL,
  `format` varchar(12) DEFAULT 'f_string' COMMENT 'f_string | jinja2 | mustache',
  `lang` varchar(12) DEFAULT 'en' COMMENT 'en | zh_CN | ...',
...
CREATE TABLE IF NOT EXISTS `flow_info` (
  ...
  `format` varchar(12) DEFAULT 'langflow',
  `example` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_info` (
  ...
  `manifest_format` varchar(12) DEFAULT 'dash_scope' COMMENT 'dash_scope | open_ai',
...
CREATE TABLE IF NOT EXISTS `character_backend` (
  ...
  `chat_example_prompt_task_id` varchar(32) NOT NULL,
  `greeting_prompt_task_id` varchar(32) NOT NULL,
  `experience_prompt_task_id` varchar(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `prompt_task` (
  ...
  `gmt_create` datetime NOT NULL,
  `gmt_modified` datetime NOT NULL,
  `gmt_executed` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `non_real_time_config` (
  ...
  `format` varchar(12) DEFAULT 'kv' COMMENT 'kv | json | yaml',
